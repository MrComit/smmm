...
#define OBJ_FLAG_DRAW_DIST_IS_ACTIVE_DIST         (1 << 20) // 0x00100000
#define OBJ_FLAG_RED_COIN_OBJ                     (1 << 21) // 0x00200000
...
#define ACTIVE_PARTICLE_DIZZY                (1 << 21) // 0x00200000
#define ACTIVE_PARTICLE_GP_RED_CIRCLE        (1 << 22) // 0x00200000
...
/* Koopa */
    ...
    #define KOOPA_SHELLED_ACT_HIT 3
    #define KOOPA_SHELLED_ACT_DIE 4
    #define KOOPA_SHELLED_ACT_DEAD 5
    #define KOOPA_SHELLED_ACT_UNDEAD 6
