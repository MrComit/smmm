...
const GeoLayout horizontal_pole_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, horizontal_pole_HorizontalPole_mesh_layer_6),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, horizontal_pole_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, horizontal_pole_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
