               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     ...
                     GEO_OPEN_NODE(),
                        ...
                        GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, door_keylock_mesh),
                        GEO_CLOSE_NODE(),
                     GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     ...
                     GEO_OPEN_NODE(),
                        GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, door_seg3_lock1),
                        GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, door_seg3_lock2),
                        GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, door_seg3_lock3),
                        GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, door_seg3_lock4),
                        GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
               GEO_RENDER_RANGE(1000, 32767),
