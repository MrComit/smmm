...
const BehaviorScript bhvFloorSwitchHiddenObjects[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SET_INT(oBehParams2ndByte, 2),
    OR_LONG(oFlags, OBJ_FLAG_RED_COIN_OBJ),
...
const BehaviorScript bhvHiddenObject[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_LONG(oFlags, (OBJ_FLAG_RED_COIN_OBJ | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
...
const BehaviorScript bhvL2FallingFloor[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_LONG(oFlags, (OBJ_FLAG_DISABLE_ON_ROOM_CLEAR | OBJ_FLAG_DONT_CALC_COLL_DIST | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
...
const BehaviorScript bhvPingpongPaddle[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_DISABLE_ON_ROOM_CLEAR | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    // CALL_NATIVE(bhv_pingpong_ball_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvChampagne[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_LONG(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_DISABLE_ON_ROOM_CLEAR)),
...
const BehaviorScript bhvTheController[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_DISABLE_TO_ROOM_CLEAR | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO)),
...
const BehaviorScript bhvEndSpike[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_DISABLE_TO_ROOM_CLEAR | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
...
const BehaviorScript bhvFakeMario[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_DISABLE_TO_ROOM_CLEAR | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO)),
    // LOAD_ANIMATIONS(oAnimations, controller_anims),
    // ANIMATE(0),
    SET_HOME(),
    // HIDE(),
...
const BehaviorScript bhvRedSparkles[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_LONG(oFlags, (OBJ_FLAG_RED_COIN_OBJ | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_HITBOX(/*Radius*/ 100, /*Height*/ 100),
    SET_INT(oIntangibleTimer, 0),
...
const BehaviorScript bhvRedCoinGoomba[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_LONG(oFlags, (OBJ_FLAG_RED_COIN_OBJ | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    //DROP_TO_FLOOR(),
    LOAD_ANIMATIONS(oAnimations, goomba_seg8_anims_0801DA4C),
    SET_HOME(),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 40, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
...
const BehaviorScript bhvInvisRedCoin[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_LONG(oFlags, (OBJ_FLAG_RED_COIN_OBJ | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_DONT_CALC_COLL_DIST)),
...
const BehaviorScript bhvFakeRedCoin[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_LONG(oFlags, (OBJ_FLAG_RED_COIN_OBJ | OBJ_FLAG_MULTIROOM | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BILLBOARD(),
    SET_INT(oIntangibleTimer, 0),
    SET_INT(oAnimState, -1),
...
const BehaviorScript bhvRedLightButton[] = {
    BEGIN(OBJ_LIST_SURFACE),
    // Floor switch - common:
    OR_LONG(oFlags, (OBJ_FLAG_RED_COIN_OBJ | OBJ_FLAG_DONT_CALC_COLL_DIST | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(light_button_collision),
    SET_FLOAT(oCollisionDistance, 0x7FFF),
    //CALL_NATIVE(bhv_light_button_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvRedVase[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_LONG(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_DONT_CALC_COLL_DIST)),
    LOAD_COLLISION_DATA(red_vase_collision),
    // SCALE(0, 150),
    // SET_HOME(),
    SET_FLOAT(oDrawingDistance, 0x7FFF),
    SET_FLOAT(oCollisionDistance, 0x7FFF),
    // CALL_NATIVE(bhv_bg_ground_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_red_vase_loop),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};


const BehaviorScript bhvProspectorT[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, toad_friend_anims),
    ANIMATE(6),
    ...
    SET_INT(oOpacity, 255),
    SET_FLOAT(oGraphYOffset, -14),
    CALL_NATIVE(bhv_prospector_t_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvEndStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SCALE(0, 40),
    CALL_NATIVE(bhv_end_star_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvBooBubble[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BILLBOARD(),
...
const BehaviorScript bhvBooBubbleCage[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INT(oIntangibleTimer, 0),
    SET_HOME(),
...
const BehaviorScript bhvSaveStation[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 100),
...
const BehaviorScript bhvC2Lemon[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(c2_lemon_collision),
    SET_FLOAT(oDrawingDistance, 0x4000),
    SET_HOME(),
    CALL_NATIVE(bhv_sinking_plat_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvC2BouncyBed[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(c2_bouncy_bed_collision),
    SET_FLOAT(oDrawingDistance, 0x4000),
    CALL_NATIVE(bhv_bouncy_bed_init),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
...
const BehaviorScript bhvC2LightningSpinner[] = {
    BEGIN(OBJ_LIST_DESTRUCTIVE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, c2_lightning_spinner_anims),
    SET_FLOAT(oDrawingDistance, 0x1000),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_lightning_spinner_loop),
...
const BehaviorScript bhvC2Lightning[] = {
    BEGIN(OBJ_LIST_DESTRUCTIVE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    // LOAD_ANIMATIONS(oAnimations, lightning_anims),
    // ANIMATE(0),
    ...
    SET_HOME(),
    CALL_NATIVE(bhv_lightning_init),
    SPAWN_OBJ(MODEL_C2_LIGHTNING_SPINNER, bhvC2LightningSpinner),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_lightning_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvC5SpinningPlat[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_LONG(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_DONT_DISPLACE_MARIO)),
    LOAD_COLLISION_DATA(c5_spinning_plat_collision),
    SET_FLOAT(oDrawingDistance, 0x4000),
    SET_HOME(),
    // SCALE(0, 90),
    BEGIN_LOOP(),
