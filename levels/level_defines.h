...
DEFINE_LEVEL("TERESA OBAKE", LEVEL_BBH, COURSE_BBH, bbh, spooky, 20000, 0x00, 0x00, 0x00, sDynBbh, sCamBBH) 
DEFINE_LEVEL("YYAMA1 % YSLD1", LEVEL_CCM, COURSE_CCM, ccm, snow, 20000, 0x00, 0x00, 0x00, _, sCamCCM) 
DEFINE_LEVEL("SELECT ROOM", LEVEL_CASTLE, COURSE_NONE, castle_inside, inside, 20000, 0x20, 0x20, 0x30, _, sCamCastle) 
DEFINE_LEVEL("HORROR DUNGEON", LEVEL_HMC, COURSE_HMC, hmc, cave, 20000, 0x00, 0x00, 0x00, sDynHmc, sCamHMC) 
DEFINE_LEVEL("SABAKU % PYRMD", LEVEL_SSL, COURSE_SSL, ssl, generic, 20000, 0x00, 0x00, 0x00, _, sCamSSL) 
DEFINE_LEVEL("BATTLE FIELD", LEVEL_BOB, COURSE_BOB, bob, generic, 20000, 0x00, 0x00, 0x00, _, sCamBOB) 
DEFINE_LEVEL("YUKIYAMA2", LEVEL_SL, COURSE_SL, sl, snow, 20000, 0x00, 0x00, 0x00, _, sCamSL) 
DEFINE_LEVEL("POOL KAI", LEVEL_WDW, COURSE_WDW, wdw, grass, 20000, 0x00, 0x00, 0x00, sDynWdw, sCamWDW) 
DEFINE_LEVEL("WTDG % TINBOTU", LEVEL_JRB, COURSE_JRB, jrb, water, 20000, 0x00, 0x00, 0x00, sDynJrb, sCamJRB) 
DEFINE_LEVEL("BIG WORLD", LEVEL_THI, COURSE_THI, thi, grass, 20000, 0x00, 0x00, 0x00, _, sCamTHI) 
DEFINE_LEVEL("CLOCK TOWER", LEVEL_TTC, COURSE_TTC, ttc, machine, 20000, 0x00, 0x00, 0x00, _, sCamTTC) 
DEFINE_LEVEL("RAINBOW CRUISE", LEVEL_RR, COURSE_RR, rr, sky, 20000, 0x00, 0x00, 0x00, _, sCamRR) 
...
DEFINE_LEVEL("FIREB1 % INVLC", LEVEL_LLL, COURSE_LLL, lll, fire, 20000, 0x00, 0x00, 0x00, _, sCamLLL) 
DEFINE_LEVEL("WATER LAND", LEVEL_DDD, COURSE_DDD, ddd, water, 20000, 0x00, 0x00, 0x00, sDynDdd, sCamDDD) 
DEFINE_LEVEL("MOUNTAIN", LEVEL_WF, COURSE_WF, wf, grass, 20000, 0x00, 0x00, 0x00, _, sCamWF) 
...
DEFINE_LEVEL("DONKEY % SLID2", LEVEL_TTM, COURSE_TTM, ttm, mountain, 20000, 0x00, 0x00, 0x00, _, sCamTTM) 
