...
const GeoLayout ssl_dl_b_002_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout ssl_dl_c_003_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ssl_dl_Debris_001_mesh_layer_1),
...
const GeoLayout ssl_dl_204__The_Mind_Palace_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_SWITCH_CASE(2, geo_switch_palace),
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, ssl_dl_b_002_geo),
			GEO_BRANCH(1, ssl_dl_c_003_geo),
		GEO_CLOSE_NODE(),
...
const GeoLayout ssl_dl_207__Outside4_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ssl_dl_CamFloorVisuals_mesh_layer_1),
...
const GeoLayout ssl_dl_b_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 0, 0, -65536, ssl_dl_ArtWall_012_mesh_layer_4),
...
const GeoLayout ssl_dl_c_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 0, 0, -65536, ssl_dl_ArtWall_011_mesh_layer_4),
...
const GeoLayout ssl_dl_b_001_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 0, -65536, ssl_dl_NULLTri_015_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout ssl_dl_c_001_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout ssl_dl_210__Observatory_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_SWITCH_CASE(2, geo_switch_observatory_top),
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, ssl_dl_b_001_geo),
			GEO_BRANCH(1, ssl_dl_c_001_geo),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 0, -65536, ssl_dl_NULLTri_014_mesh_layer_1),
