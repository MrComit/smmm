...
ALIGNED8 static const Texture magic_carpet_corner[] = {
#include "levels/ssl/CUSTOM_carpet_corner.rgba16.inc.c"
};
...
const s16 magic_carpet_static_vertex_data[] = {
//     x     z    tx    ty
    -306,  205,    0,    0,
    -306,    0,  992,    0,
    -306, -204,    0,    0,
...
const Gfx dl_magic_carpet_begin[] = {
    gsDPPipeSync(),
    ...
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, magic_carpet_corner),
    gsDPLoadSync(),
...
const Gfx dl_magic_carpet_model_half[] = {
