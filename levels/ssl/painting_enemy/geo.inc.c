...
const GeoLayout painting_enemy_switch_opt2[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, painting_enemy_penemy_mesh_layer_6_mat_override_ShyguyPainting_v4_001_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout painting_enemy_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_ASM(6, geo_update_opacity_and_color),
			...
			GEO_OPEN_NODE(),
				...
				GEO_BRANCH(1, painting_enemy_switch_opt2),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
