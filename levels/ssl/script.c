...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(MODEL_MIND_CHANDELIER, 17195, 6847, -11035, 0, 0, 0, 0x00000000, bhvMindChandelier),
		OBJECT(MODEL_MIND_CHANDELIER, 17195, 6847, -12604, 0, 90, 0, 0x00000000, bhvMindChandelier),
	...
	AREA(2, ssl_area_2),
		...
		OBJECT(MODEL_OBS_BOOGOO, -8580, 6934, -1675, 0, 0, 0, (5 << 16) | (5 << 8), bhvBoogooObject),
		OBJECT(MODEL_OBS_BOOGOO, -14904, 5774, 570, 0, 0, 0, (5 << 16) | (4 << 8), bhvBoogooObject),
