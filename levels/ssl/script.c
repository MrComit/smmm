...
const LevelScript level_ssl_entry[] = {
	...
	AREA(2, ssl_area_2),
		...
		OBJECT(MODEL_YOSHI_HEAD, -2439, 2950, -44963, 0, 180, 0, (70 << 16), bhvYoshiHeadLine),
		OBJECT(MODEL_YOSHI_HEAD, -3026, 2950, -46363, 0, 0, 0, (70 << 16), bhvYoshiHeadLine),
		OBJECT(MODEL_YOSHI_HEAD, -3598, 2950, -44963, 0, 180, 0, (70 << 16), bhvYoshiHeadLine),
		OBJECT(MODEL_YOSHI_HEAD, -4149, 2950, -46363, 0, 0, 0, (70 << 16), bhvYoshiHeadLine),
		OBJECT(MODEL_YOSHI_HEAD, -8073, 2992, -51588, 0, 0, 0, (14 << 24) | (11 << 16), bhvYoshiHeadRectangle),
		OBJECT(MODEL_YOSHI_HEAD, -8073, 2992, -51588, 0, -180, 0, (14 << 24) | (11 << 16) | (2 << 8), bhvYoshiHeadRectangle),
		OBJECT(MODEL_YOSHI_HEAD, -4532, 2992, -49296, 0, 0, 0, (1 << 16), bhvYoshiHeadSpin),
		OBJECT(MODEL_YOSHI_HEAD, -3939, 2992, -50972, 0, 0, 0, 0x00000000, bhvYoshiHeadSpin),
		OBJECT(MODEL_YOSHI_HEAD, -2771, 2992, -50972, 0, -180, 0, 0x00000000, bhvYoshiHeadSpin),
		OBJECT(MODEL_YOSHI_HEAD, -3091, 18799, -51974, 0, -90, 0, (90 << 16), bhvYoshiHeadLine),
		OBJECT(MODEL_YOSHI_HEAD, -7491, 18799, -50978, 0, 0, 0, (12 << 24) | (14 << 16), bhvYoshiHeadRectangle),
		OBJECT(MODEL_YOSHI_HEAD, -7491, 18799, -50978, 0, -180, 0, (12 << 24) | (14 << 16) | (2 << 8), bhvYoshiHeadRectangle),
		OBJECT(MODEL_YOSHI_HEAD, -1641, 18799, -49998, 0, 0, 0, 0x00000000, bhvYoshiHeadSpin),
