...
const LevelScript level_ssl_entry[] = {
	...
	AREA(2, ssl_area_2),
		...
		OBJECT(MODEL_YOSHI_HEAD, -1470, 16799, 17530, 0, -90, 0, (60 << 16), bhvYoshiHeadLine),
		OBJECT(MODEL_YOSHI_HEAD, -3683, 16799, 14558, 0, 0, 0, (12 << 24) | (14 << 16), bhvYoshiHeadRectangle),
		OBJECT(MODEL_YOSHI_HEAD, -3683, 16799, 14558, 0, -180, 0, (12 << 24) | (14 << 16) | (2 << 8), bhvYoshiHeadRectangle),
		OBJECT(MODEL_YOSHI_HEAD, -6485, 16799, 14929, 0, 0, 0, 0x00000000, bhvYoshiHeadSpin),
