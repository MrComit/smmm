...
const LevelScript level_ssl_entry[] = {
	...
	AREA(2, ssl_area_2),
		...
		OBJECT(MODEL_YOSHI_HEAD, -3091, 16799, 13562, 0, -90, 0, (90 << 16), bhvYoshiHeadLine),
		OBJECT(MODEL_YOSHI_HEAD, -7491, 16799, 14558, 0, 0, 0, (12 << 24) | (14 << 16), bhvYoshiHeadRectangle),
		OBJECT(MODEL_YOSHI_HEAD, -7491, 16799, 14558, 0, -180, 0, (12 << 24) | (14 << 16) | (2 << 8), bhvYoshiHeadRectangle),
		OBJECT(MODEL_YOSHI_HEAD, -1641, 16799, 15538, 0, 0, 0, 0x00000000, bhvYoshiHeadSpin),
