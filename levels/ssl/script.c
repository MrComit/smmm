...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(MODEL_NONE, -19324, 2268, 357, 0, -180, 0, (0x1A << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -19324, 2268, 357, 0, -180, 0, (0xA << 16), bhvFlyingWarp),
		MARIO_POS(0x01, -180, -19324, 2268, 357),
		...
		OBJECT(MODEL_PEEPA, -19879, 2268, -1847, 0, -90, 0, (1 << 24), bhvFloorPeepa),
		OBJECT(MODEL_PEEPA, -19879, 2068, -1847, 0, -90, 0, (1 << 16), bhvFloorPeepa),
		OBJECT(MODEL_PEEPA, -19879, 1868, -1847, 0, -90, 0, (2 << 16), bhvFloorPeepa),
