...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(MODEL_PAINTING_ENEMY, -20038, 2467, 1328, 0, -90, 0, (1 << 16), bhvPaintingEnemy),
		OBJECT(MODEL_PAINTING_ENEMY, -18603, 2467, 1328, 0, 90, 0, (1 << 16), bhvPaintingEnemy),
		OBJECT(MODEL_PAINTING_ENEMY, -19321, 2467, 778, 0, 180, 0, (1 << 16), bhvPaintingEnemy),
