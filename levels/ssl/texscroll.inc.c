...
void scroll_sts_mat_ssl_dl_WoodFloorTrophyRoom_002_v5_layer1() {
	static int intervalTex1 = 3;
	static int curInterval1 = 3;
	Gfx *mat = segmented_to_virtual(mat_ssl_dl_WoodFloorTrophyRoom_002_v5_layer1);
...
void scroll_ssl() {
	...
	scroll_sts_mat_ssl_dl_WoodFloorTrophyRoom_002_v5_layer1();
}
