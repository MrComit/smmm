...
const LevelScript level_ddd_entry[] = {
	...
	LOAD_MODEL_FROM_DL(MODEL_CONSOLE_END_BUBBLE, end_bubble_Bubble_mesh, LAYER_OPAQUE), 
	...
	AREA(1, ddd_area_1),
		...
		INSTANT_WARP(1, 0x01, 1425, 19415, 9124),
		INSTANT_WARP(2, 0x01, -27950, 23714, -6608),
		WARP_NODE(0xAB, LEVEL_SL, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xAC, LEVEL_SL, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xAD, LEVEL_SL, 0x03, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xAE, LEVEL_SL, 0x04, 0x0A, WARP_NO_CHECKPOINT),
