...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 7, 398, -12270, 0, 0, 0, 0x000A0000, bhvFlyingWarp),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 3923, 0, -4961, 0, 0, 0, 0x00000000, bhvBreakableBox),
		OBJECT(MODEL_BROKEN_KEY, -1503, 0, -9690, 0, 0, 0, 0x00070000, bhvBrokenKey),
		OBJECT(MODEL_BROKEN_KEY, -803, 0, -9690, 0, 0, 0, 0x00080000, bhvBrokenKey),
		OBJECT(MODEL_BROKEN_KEY, -95, 0, -9690, 0, 0, 0, 0x01090000, bhvBrokenKey),
		...
		OBJECT(MODEL_TOKEN, -3395, -16, -10704, 0, 0, 0, 0x00001500, bhvToken),
