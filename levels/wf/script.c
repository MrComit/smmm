...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_L2_FALLING_FLOOR, 2073, 0, -13043, 0, 0, 0, 0x00000000, bhvL2FallingFloor),
		OBJECT(MODEL_L2_FALLING_FLOOR, 3616, 0, -12404, 0, 0, 0, 0x00010000, bhvL2FallingFloor),
		OBJECT(MODEL_L2_FALLING_FLOOR, 4023, 0, -14484, 0, 0, 0, 0x00010000, bhvL2FallingFloor),
		OBJECT(MODEL_L2_FALLING_FLOOR, 2206, 0, -15073, 0, 0, 0, 0x00020000, bhvL2FallingFloor),
		OBJECT(MODEL_PIPESEG, 3545, -2339, -12404, 0, 0, 0, 0x00000000, bhvPipeseg),
		OBJECT(MODEL_SKEETER, 2264, -2456, -13967, 0, 0, 0, 0x00000000, bhvSkeeter),
		OBJECT(MODEL_SKEETER, 1186, -2456, -13965, 0, 0, 0, 0x00000000, bhvSkeeter),
		OBJECT(MODEL_SKEETER, 1708, -2580, -14363, 0, 0, 0, 0x00000000, bhvSkeeter),
		OBJECT(MODEL_SKEETER, 2014, -2515, -15312, 0, 0, 0, 0x00000000, bhvSkeeter),
		OBJECT(MODEL_SKEETER, 1139, -2515, -15537, 0, 0, 0, 0x00000000, bhvSkeeter),
		OBJECT(MODEL_SKEETER, 1650, -2515, -14761, 0, 0, 0, 0x00000000, bhvSkeeter),
