...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 3366, 200, -2821, 0, 90, 0, 0x000A0000, bhvFlyingWarp),
		...
		OBJECT(MODEL_BOUNCY_BED, 5813, -133, -3321, 0, 27, 0, 0x00000000, bhvBouncyBed),
		OBJECT(MODEL_BOUNCY_BED, 6892, -355, -2262, -24, -23, 2, 0x00000000, bhvBouncyBed),
		OBJECT(MODEL_PRESSURE_PLATE, 4511, 0, -2128, 0, 0, 0, 0x00000000, bhvServantsPlate),
		OBJECT(MODEL_ENV_FLAME, 6035, 1135, -4232, 0, 0, 0, 0x00000000, bhvServantsFlame),
		OBJECT(MODEL_ENV_FLAME, 6035, 1135, -1339, 0, 0, 0, 0x00000000, bhvServantsFlame),
		OBJECT(MODEL_ENV_FLAME, 8015, 1135, -4232, 0, 0, 0, 0x00000000, bhvServantsFlame),
		...
		OBJECT(MODEL_ENV_FLAME, 9995, 1135, -1339, 0, 0, 0, 0x00000000, bhvServantsFlame),
		OBJECT(MODEL_ENV_FLAME, 11975, 1135, -4232, 0, 0, 0, 0x00000000, bhvServantsFlame),
