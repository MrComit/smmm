...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 1031, 200, -4082, 0, -180, 0, 0x00230100, bhvFadingWarp),
		...
		OBJECT(MODEL_LEMON, -790, -175, 2999, 0, 0, 0, 0x01640000, bhvLemon),
		...
		OBJECT(MODEL_NONE, -2059, -500, 3060, 0, 0, 0, 0x00790000, bhvPoleGrabbing),
		OBJECT(MODEL_TOKEN, 2573, -230, -1117, 0, 99, 0, 0x00000800, bhvToken),
		OBJECT(MODEL_TOKEN, -3444, 900, 2995, 0, 90, 0, 0x00010900, bhvToken),
