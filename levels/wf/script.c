...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, -5451, 250, -7439, 0, 0, 0, 0x000A0000, bhvFlyingWarp),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -5472, 0, -7090, 0, 180, 0, 0x00000000, bhvDoor),
		...
		OBJECT(MODEL_BOO, 17018, 649, -3330, 0, 0, 0, 0x00090000, bhvRoomBoo),
		...
		OBJECT(MODEL_ENV_FLAME, -5752, 495, -3965, 0, 0, 0, 0x00000000, bhvMastersFlame),
		OBJECT(MODEL_ENV_FLAME, -6337, 495, -3965, 0, 0, 0, 0x00010000, bhvMastersFlame),
		OBJECT(MODEL_ENV_FLAME, -6922, 495, -3965, 0, 0, 0, 0x00020000, bhvMastersFlame),
