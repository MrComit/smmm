...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_L2_GATE, -3242, 0, -9236, 0, 45, 0, 0x00010000, bhvL2Gate),
		OBJECT(MODEL_L2_GATE, 1720, 0, -9728, 0, -45, 0, 0x00020000, bhvL2Gate),
		...
		OBJECT(MODEL_HEAVY_SWITCH, 208, 0, -8117, 0, 0, 0, 0x00000000, bhvHeavySwitch),
		OBJECT(MODEL_HEAVY_SWITCH, -105, 0, -7692, 0, 0, 0, 0x00010000, bhvHeavySwitch),
		OBJECT(MODEL_HEAVY_SWITCH, -558, 0, -8182, 0, 0, 0, 0x00020000, bhvHeavySwitch),
