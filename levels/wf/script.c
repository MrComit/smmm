...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_ENV_FLAME, 6035, 1135, -1395, 0, 0, 0, 0x00000000, bhvServantsFlame),
		OBJECT(MODEL_ENV_FLAME, 8015, 1135, -4232, 0, 0, 0, 0x00000000, bhvServantsFlame),
		OBJECT(MODEL_ENV_FLAME, 8015, 1135, -1395, 0, 0, 0, 0x00000000, bhvServantsFlame),
		OBJECT(MODEL_ENV_FLAME, 9995, 1135, -4232, 0, 0, 0, 0x00000000, bhvServantsFlame),
		OBJECT(MODEL_ENV_FLAME, 9995, 1135, -1395, 0, 0, 0, 0x00000000, bhvServantsFlame),
		OBJECT(MODEL_ENV_FLAME, 11975, 1135, -4232, 0, 0, 0, 0x00000000, bhvServantsFlame),
		OBJECT(MODEL_ENV_FLAME, 11975, 1135, -1395, 0, 0, 0, 0x00000000, bhvServantsFlame),
