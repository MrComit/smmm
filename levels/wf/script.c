...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_RED_COIN, 30, 0, -8350, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 390, 0, -7928, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_PURPLE_SWITCH, -381, 216, 15128, 0, -180, 0, (20 << 24), bhvFloorSwitchHiddenObjects),
