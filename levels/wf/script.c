...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_CASTLE_KEY_DOOR, 33, 0, -19134, 0, -180, 0, (2 << 16), bhvBigKeyDoor),
		OBJECT(MODEL_CASTLE_KEY_DOOR, -117, 0, -19134, 0, 0, 0, (2 << 16), bhvBigKeyDoor),
		...
		OBJECT(MODEL_NONE, 6874, 160, -7748, 0, 0, 0, 0x00AF0000, bhvPlaysetEntrance),
		OBJECT(MODEL_NONE, 6411, 160, -7748, 0, 0, 0, 0x01AE0000, bhvPlaysetEntrance),
