...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_ENV_FLAME, -5472, 100, -10235, 0, 0, 0, 0x00802000, bhvEnvFlame),
		OBJECT(MODEL_ENV_FLAME, -5472, 100, -12335, 0, 0, 0, 0x96008F00, bhvEnvFlame),
		OBJECT(MODEL_ENV_FLAME, -7572, 100, -12335, 0, 0, 0, 0x58009600, bhvEnvFlame),
		OBJECT(MODEL_ENV_FLAME, -7572, 100, -10235, 0, 0, 0, 0x96690000, bhvEnvFlame),
