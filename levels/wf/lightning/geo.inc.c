...
const GeoLayout lightning_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, lightning_mark_mesh_layer_6),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, lightning_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
