...
const GeoLayout wf_dl_02__Bar_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(5, -718, 350, -4206, wf_dl_Bottle_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(2, wf_dl_Bottle_mesh_layer_2),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, 0, 0, -17911, wf_dl_Hallway_003_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 1181, -100, 1039, wf_dl_Lava_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
