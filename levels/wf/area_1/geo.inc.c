...
const GeoLayout wf_dl_03__Balcony_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, 342, 190, 8638, wf_dl_Cloud_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(4, 342, 190, 8638, wf_dl_Cloud_002_mesh_layer_4),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, 1017, 316, 8638, wf_dl_Lightning_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(6, wf_dl_Lightning_mesh_layer_6),
			GEO_DISPLAY_LIST(4, wf_dl_Lightning_mesh_layer_4),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(4, 1039, 1848, 22507, wf_dl_Moon_mesh_layer_4),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, 4792, -4000, 16377, wf_dl_Tree_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(4, wf_dl_Tree_mesh_layer_4),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, 106, -397, 9287, wf_dl_WeatherVane_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
