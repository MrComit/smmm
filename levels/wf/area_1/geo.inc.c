...
const GeoLayout wf_dl_01__Lounge_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, -467, 71, -6328, wf_dl_Chair_003_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, -630, 71, -5826, wf_dl_Chair_004_mesh_layer_1),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, -560, 82, -6074, wf_dl_Simple_Table_002_mesh_layer_1),
