...
const GeoLayout wf_dl_01__Lounge_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, 3597, 280, -8794, wf_dl_Bookshelf_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 3743, 71, -5601, wf_dl_Chair_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 3118, 178, -7172, wf_dl_Couch_mesh_layer_1),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, 6496, 2500, -10469, wf_dl_HalfPillar_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 0, 0, -17911, wf_dl_Hallway_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 1854, 82, -7294, wf_dl_Simple_Table_mesh_layer_1),
