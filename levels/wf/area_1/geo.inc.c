...
const GeoLayout wf_dl_01__Lounge_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, -2045, 71, -10416, wf_dl_Chair_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, -2032, 71, -9889, wf_dl_Chair_002_mesh_layer_1),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, -2048, 82, -10145, wf_dl_Simple_Table_mesh_layer_1),
