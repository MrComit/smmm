...
const GeoLayout wf_dl_04__Bathroom_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, 4023, -1394, -15067, wf_dl_Pipes_002_mesh_layer_1),
		...
		GEO_TRANSLATE_NODE_WITH_DL(5, 3606, -2211, -12540, wf_dl_Water_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(6, wf_dl_Water_mesh_layer_6),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
