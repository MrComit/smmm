...
const GeoLayout wf_dl_01__Lounge_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(5, -531, 244, -6923, wf_dl_Bottle_007_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(1, wf_dl_Bottle_007_mesh_layer_1),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(5, -484, 244, -7109, wf_dl_Bottle_008_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(1, wf_dl_Bottle_008_mesh_layer_1),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(5, -2714, 244, -8793, wf_dl_Bottle_009_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(1, wf_dl_Bottle_009_mesh_layer_1),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(5, -2528, 244, -8837, wf_dl_Bottle_010_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(1, wf_dl_Bottle_010_mesh_layer_1),
		GEO_CLOSE_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(5, -438, 238, -7706, wf_dl_Hallway_007_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(4, 1021, 333, -9999, wf_dl_Hallway_008_mesh_layer_4),
...
const GeoLayout wf_dl_02__Bar_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(5, 1245, 1572, 630, wf_dl_Bottle_005_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(4, wf_dl_Bottle_005_mesh_layer_4),
		GEO_CLOSE_NODE(),
...
const GeoLayout wf_dl_15__Hallway_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, -3449, 1333, -3628, wf_dl_Master_Bedroom_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, -3389, 465, -2882, wf_dl_ToFloor1_002_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout wf_dl_16__Hallway_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, 1021, 333, -9999, wf_dl_Hallway_010_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout wf_dl_17__Play_Room_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, 1021, 333, -9999, wf_dl_Hallway_011_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
