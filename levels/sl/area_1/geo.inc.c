...
const GeoLayout sl_dl_108__Basement_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, -8386, -3007, 13924, sl_dl_Glow_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, sl_dl_Meat_003_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, sl_dl_Tomatos_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -8386, -3007, 13924, sl_dl_TortureChamber_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -8386, -3007, 13924, sl_dl_TortureChamberUnder_mesh_layer_1),
