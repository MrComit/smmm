...
const LevelScript level_sl_entry[] = {
	...
	AREA(1, sl_area_1),
		...
		WARP_NODE(0x82, LEVEL_SL, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x83, LEVEL_SL, 0x03, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -191, 192, 16137, 0, -180, 0, 0x000B0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -191, 192, 16137, 0, -180, 0, 0x000A0000, bhvFlyingWarp),
		MARIO_POS(0x01, -180, -191, 192, 16137),
		...
		OBJECT(MODEL_TOAD_FRIEND, -485, -82, 15867, 0, -43, 0, (DIALOG_086 << 16), bhvPostToadFriend),
		...
		OBJECT(MODEL_NONE, 7993, 135, 6812, 0, -90, 0, (DIALOG_094 << 16), bhvSignOnWall),
		OBJECT(MODEL_NONE, 7993, 135, 7675, 0, -90, 0, (DIALOG_091 << 16), bhvMariosJournal),
		...
		SET_BACKGROUND_MUSIC(0x00, SEQ_POST_MANOR),
	...
	AREA(2, sl_area_2),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_SL, 0x02, 0x0B, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -191, 192, 16137, 0, -180, 0, 0x000B0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -191, 192, 16137, 0, -180, 0, 0x000A0000, bhvFlyingWarp),
		MARIO_POS(0x01, -180, -191, 192, 16137),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -75, 0, 10351, 0, 0, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 75, 0, 10351, 0, -180, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_TOAD_FRIEND, -484, -82, 15867, 0, -43, 0, (DIALOG_086 << 16), bhvPostToadFriend),
		OBJECT(MODEL_BOO_BUBBLE, -1874, 0, 5012, 0, 0, 0, (19 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1628, 0, 4793, 0, 0, 0, (18 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 2458, 0, 7654, 0, 0, 0, (17 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 2664, 0, 8668, 0, 0, 0, (16 << 16), bhvBooBubble),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -4150, 0, 5297, 0, 90, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 4150, 0, 5297, 0, -90, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_L10_THIN_BOOK, 5166, 232, 4779, 0, 0, 0, 0x00000000, bhvSpinningBook),
		OBJECT(MODEL_L10_THIN_BOOK, 4604, 434, 4072, 0, 0, 0, 0x00000000, bhvSpinningBook),
		OBJECT(MODEL_L10_THIN_BOOK, 5508, 567, 3992, 0, 0, 0, 0x00000000, bhvSpinningBook),
		OBJECT(MODEL_NONE, 7993, 137, 6161, 0, -90, 0, (DIALOG_091 << 16), bhvMariosJournal),
		TERRAIN(sl_area_2_collision),
		ROOMS(sl_area_2_collision_rooms),
	...
	AREA(3, sl_area_3),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_SL, 0x03, 0x0B, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -191, 192, 16137, 0, -180, 0, 0x000B0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -191, 192, 16137, 0, -180, 0, 0x000A0000, bhvFlyingWarp),
		MARIO_POS(0x01, -180, -191, 192, 16137),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -75, 0, 10351, 0, 0, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 75, 0, 10351, 0, -180, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_TOAD_FRIEND, -485, -82, 15867, 0, -43, 0, (DIALOG_086 << 16), bhvPostToadFriend),
		OBJECT(MODEL_BOO_BUBBLE, -1395, 0, 6694, 0, 0, 0, (19 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1094, 0, 9665, 0, 0, 0, (18 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1294, 0, 7448, 0, 0, 0, (17 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1621, 0, 7714, 0, 0, 0, (16 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1602, 0, 7063, 0, 0, 0, (15 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1419, 0, 6661, 0, 0, 0, (14 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -1366, 0, 9748, 0, 0, 0, (13 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -871, 0, 9968, 0, 0, 0, (12 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -530, 0, 9547, 0, 0, 0, (11 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -1757, 0, 9569, 0, 0, 0, (10 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -1066, 0, 7407, 0, 0, 0, (9 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1510, 0, 9289, 0, 0, 0, (8 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -751, 0, 6728, 0, 0, 0, (7 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1428, 0, 9915, 0, 0, 0, (6 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -1252, 0, 9299, 0, 0, 0, (5 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1643, 0, 8904, 0, 0, 0, (4 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -1423, 0, 8552, 0, 0, 0, (3 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1607, 0, 8404, 0, 0, 0, (2 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, 1112, 0, 8146, 0, 0, 0, (1 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -1055, 0, 7869, 0, 0, 0, 0x00000000, bhvBooBubble),
		OBJECT(MODEL_NONE, -75, 350, 6447, 0, 0, 0, (7 << 24), bhvEndCoinCount),
		OBJECT(MODEL_END_STAR, -1900, 680, 8297, 0, 90, 0, 0x00000000, bhvEndStar),
		OBJECT(MODEL_END_STAR, -1900, 530, 8647, 0, 90, 0, (1 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -1900, 530, 7947, 0, 90, 0, (2 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -1900, 380, 8997, 0, 90, 0, (3 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -1900, 380, 7597, 0, 90, 0, (4 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -1900, 1000, 8297, 0, 90, 0, (5 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -1900, 850, 8647, 0, 90, 0, (6 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -1900, 850, 7947, 0, 90, 0, (7 << 24), bhvEndStar),
		TERRAIN(sl_area_3_collision),
		ROOMS(sl_area_3_collision_rooms),
	...
	AREA(4, sl_area_4),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_SL, 0x04, 0x0B, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -191, 192, 16137, 0, -180, 0, 0x000B0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -191, 192, 16137, 0, -180, 0, 0x000A0000, bhvFlyingWarp),
		MARIO_POS(0x01, -180, -191, 192, 16137),
		OBJECT(MODEL_BOO_BUBBLE, -198307, -148, 11801, 0, 0, 0, (19 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -195818, -148, 14773, 0, 0, 0, (18 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -195618, -148, 12555, 0, 0, 0, (17 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -195292, -148, 12821, 0, 0, 0, (16 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -195310, -148, 12170, 0, 0, 0, (15 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -195494, -148, 11769, 0, 0, 0, (14 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -198279, -148, 14855, 0, 0, 0, (13 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -197783, -148, 15075, 0, 0, 0, (12 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -197442, -148, 14654, 0, 0, 0, (11 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -198669, -148, 14677, 0, 0, 0, (10 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -197978, -148, 12514, 0, 0, 0, (9 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -195403, -148, 14396, 0, 0, 0, (8 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -197663, -148, 11835, 0, 0, 0, (7 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -195484, -148, 15022, 0, 0, 0, (6 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -198164, -148, 14406, 0, 0, 0, (5 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -195270, -148, 14011, 0, 0, 0, (4 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -198335, -148, 13659, 0, 0, 0, (3 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -195305, -148, 13511, 0, 0, 0, (2 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -195800, -148, 13253, 0, 0, 0, (1 << 16), bhvBooBubble),
		OBJECT(MODEL_BOO_BUBBLE, -197968, -148, 12976, 0, 0, 0, 0x00000000, bhvBooBubble),
		OBJECT(MODEL_NONE, -196683, -36, 10946, 0, 0, 0, (7 << 24), bhvEndCoinCount),
		OBJECT(MODEL_TOAD_FRIEND, -485, -82, 15867, 0, -43, 0, (DIALOG_086 << 16), bhvPostToadFriend),
		OBJECT(MODEL_END_STAR, -200471, 379, 13629, 0, 90, 0, 0x00000000, bhvEndStar),
		OBJECT(MODEL_END_STAR, -200471, 229, 13979, 0, 90, 0, (1 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -200471, 229, 13279, 0, 90, 0, (2 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -200471, 79, 14329, 0, 90, 0, (3 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -200471, 79, 12929, 0, 90, 0, (4 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -200471, 699, 13629, 0, 90, 0, (5 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -200471, 549, 13979, 0, 90, 0, (6 << 24), bhvEndStar),
		OBJECT(MODEL_END_STAR, -200471, 549, 13279, 0, 90, 0, (7 << 24), bhvEndStar),
		TERRAIN(sl_area_4_collision),
		ROOMS(sl_area_4_collision_rooms),
