...
const LevelScript level_sl_entry[] = {
	...
	AREA(1, sl_area_1),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, -794, -336, 13653, 0, 0, 0, 0x00820000, bhvWarpPipe),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, 770, -336, 13662, 0, 0, 0, 0x00830000, bhvWarpPipe),
