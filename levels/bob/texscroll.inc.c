...
void scroll_bob_dl_Hallway_mesh_vtx_2() {
	int i = 0;
	int count = 4;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bob_dl_Hallway_mesh_vtx_2);
...
void scroll_bob_dl_Hallway_002_mesh_vtx_0() {
	int i = 0;
	int count = 4;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bob_dl_Hallway_002_mesh_vtx_0);
...
void scroll_bob_dl_LivingRoom_mesh_vtx_2() {
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bob_dl_LivingRoom_mesh_vtx_2);
...
void scroll_bob_dl_LivingRoom_001_mesh_vtx_0() {
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bob_dl_LivingRoom_001_mesh_vtx_0);
...
void scroll_bob() {
	...
	scroll_bob_dl_Hallway_mesh_vtx_2();
	scroll_bob_dl_Hallway_002_mesh_vtx_0();
