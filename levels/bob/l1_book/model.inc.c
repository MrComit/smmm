...
Lights1 l1_book_pages_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);
...
Gfx l1_book_bookpage_ci8_aligner[] = {gsSPEndDisplayList()};
u8 l1_book_bookpage_ci8[] = {
...
Gfx l1_book_bookpage_ci8_pal_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 l1_book_bookpage_ci8_pal_rgba16[] = {
...
Gfx l1_book_Red_mesh_tri_1[] = {
	gsSPVertex(l1_book_Red_mesh_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSPEndDisplayList(),
};Vtx l1_book_Red_mesh_vtx_2[12] = {
	{{{-25, 102, 35},0, {513, -2363},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{25, 102, 35},0, {-33, -2363},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{25, 102, -35},0, {-33, 3633},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{-25, 102, -35},0, {513, 3633},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{25, 0, 35},0, {-33, 18361},{0x0, 0x81, 0x0, 0xFF}}},
	{{{-25, 0, 35},0, {513, 18361},{0x0, 0x81, 0x0, 0xFF}}},
	{{{-25, 0, -35},0, {513, 12365},{0x0, 0x81, 0x0, 0xFF}}},
	{{{25, 0, -35},0, {-33, 12365},{0x0, 0x81, 0x0, 0xFF}}},
	{{{-25, 102, -35},0, {513, 3633},{0x0, 0x0, 0x81, 0xFF}}},
	{{{25, 102, -35},0, {-33, 3633},{0x0, 0x0, 0x81, 0xFF}}},
	{{{25, 0, -35},0, {-33, 12365},{0x0, 0x0, 0x81, 0xFF}}},
	{{{-25, 0, -35},0, {513, 12365},{0x0, 0x0, 0x81, 0xFF}}},
};

Gfx l1_book_Red_mesh_tri_2[] = {
	gsSPVertex(l1_book_Red_mesh_vtx_2 + 0, 12, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
...
Gfx l1_book_root_Green_mesh_tri_0[] = {
	...
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};Vtx l1_book_root_Green_mesh_vtx_1[8] = {
...
Gfx l1_book_root_Green_mesh_tri_1[] = {
	gsSPVertex(l1_book_root_Green_mesh_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSPEndDisplayList(),
};Vtx l1_book_root_Green_mesh_vtx_2[12] = {
	{{{-25, 102, 35},0, {513, -2363},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{25, 102, 35},0, {-33, -2363},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{25, 102, -35},0, {-33, 3633},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{-25, 102, -35},0, {513, 3633},{0x0, 0x7F, 0x0, 0xFF}}},
...
Gfx l1_book_root_Green_mesh_tri_2[] = {
	gsSPVertex(l1_book_root_Green_mesh_vtx_2 + 0, 12, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
	gsSPEndDisplayList(),
...
Gfx l1_book_root_Purple_mesh_tri_0[] = {
	...
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};Vtx l1_book_root_Purple_mesh_vtx_1[8] = {
...
Gfx l1_book_root_Purple_mesh_tri_1[] = {
	gsSPVertex(l1_book_root_Purple_mesh_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSPEndDisplayList(),
};Vtx l1_book_root_Purple_mesh_vtx_2[12] = {
	{{{-25, 102, 35},0, {513, -2363},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{25, 102, 35},0, {-33, -2363},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{25, 102, -35},0, {-33, 3633},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{-25, 102, -35},0, {513, 3633},{0x0, 0x7F, 0x0, 0xFF}}},
...
Gfx l1_book_root_Purple_mesh_tri_2[] = {
	gsSPVertex(l1_book_root_Purple_mesh_vtx_2 + 0, 12, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
	gsSPEndDisplayList(),
...
Gfx mat_l1_book_pages[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureLUT(G_TT_RGBA16),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, l1_book_bookpage_ci8_pal_rgba16),
	gsDPTileSync(),
	gsDPSetTile(0, 0, 0, 256, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadSync(),
	...
	gsDPPipeSync(),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_8b, 16, l1_book_bookpage_ci8),
	...
	gsSPSetLights1(l1_book_pages_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_l1_book_pages[] = {
	gsDPPipeSync(),
	gsDPSetTextureLUT(G_TT_NONE),
	gsSPEndDisplayList(),
};
...
Gfx l1_book_Red_mesh[] = {
	...
	gsSPDisplayList(mat_l1_book_pages),
	gsSPDisplayList(l1_book_Red_mesh_tri_2),
	gsSPDisplayList(mat_revert_l1_book_pages),
	gsSPEndDisplayList(),
};
...
Gfx l1_book_root_Green_mesh[] = {
	...
	gsSPDisplayList(mat_revert_l1_book_BookSides),
	gsSPDisplayList(mat_l1_book_pages),
	gsSPDisplayList(l1_book_root_Green_mesh_tri_2),
	gsSPDisplayList(mat_revert_l1_book_pages),
	gsSPEndDisplayList(),
};
...
Gfx l1_book_root_Purple_mesh[] = {
	...
	gsSPDisplayList(mat_revert_l1_book_BookSides),
	gsSPDisplayList(mat_l1_book_pages),
	gsSPDisplayList(l1_book_root_Purple_mesh_tri_2),
	gsSPDisplayList(mat_revert_l1_book_pages),
	gsSPEndDisplayList(),
};
