...
const GeoLayout bob_dl_Room1C_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 3575, 267, 12827, bob_dl_Plant_001_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 3575, 267, 12827, bob_dl_Plant_002_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 3575, 267, 12827, bob_dl_Plant_003_mesh),
