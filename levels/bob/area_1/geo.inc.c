...
const GeoLayout bob_dl_Room1B_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 3276, 745, 17259, bob_dl_Painting_008_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3276, 745, 16759, bob_dl_Painting_010_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_DECAL, -3247, 745, 20759, bob_dl_Painting_011_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_DECAL, 3276, 745, 21259, bob_dl_Painting_012_mesh),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 2604, 47, 21313, bob_dl_Pillar_010_mesh),
...
const GeoLayout bob_dl_Room1E_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE_DECAL, -10789, 280, 3088, bob_dl_Bookshelf_013_mesh),
...
const GeoLayout bob_dl_Room1H_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 780, 305, 3995, bob_dl_Kitchen_003_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 403, 87, 3902, bob_dl_SpiderWeb_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 1177, 458, 3926, bob_dl_SpiderWeb_006_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout bob_dl_Room1I_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -6722, -340, 6414, bob_dl_Couch_004_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -7159, -220, 5807, bob_dl_Couch_005_mesh),
...
const GeoLayout bob_dl_Room1K_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -9757, 983, 12805, bob_dl_Library_003_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -9757, 983, 12805, bob_dl_Library_004_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, -9757, 983, 12805, bob_dl_Library_006_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -5783, 1944, 16909, bob_dl_Library_007_mesh),
...
const GeoLayout bob_dl_Room1L_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -9757, 983, 12805, bob_dl_QuickHall_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -4355, 1263, 17158, bob_dl_QuickHall_001_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout bob_dl_Room1M_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 1111, 531, 19291, bob_dl_MainHall_012_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 163, 10414, bob_dl_MainHall_013_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout bob_dl_Room1N_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 1111, 531, 19291, bob_dl_MainHall_014_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
