...
const GeoLayout bob_dl_Room1J_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -11420, 251, 7608, bob_dl_Bucket_mesh),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, -11420, 251, 7608, bob_dl_Water_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout bob_dl_Room1K_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -9876, 125, 3763, bob_dl_Library_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
