...
const GeoLayout bob_dl_Room1E_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 4105, 100, 3810, bob_dl_MRoomCrate_005_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 4105, 300, 3810, bob_dl_MRoomCrate_006_mesh),
