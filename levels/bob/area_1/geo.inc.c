...
const GeoLayout bob_dl_Room1A_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -1261, 100, 28602, bob_dl_Dresser_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -966, 0, 27615, bob_dl_Lamp_mesh),
...
const GeoLayout bob_dl_Room1B_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 0, 28197, bob_dl_Atrium_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
