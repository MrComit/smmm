...
const GeoLayout bob_dl_Room1I_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -2892, 144, 5435, bob_dl_Couch_001_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3366, 297, 5411, bob_dl_Couch_002_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -5252, 178, 8610, bob_dl_Couch_008_mesh),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_DECAL, -7773, -300, 7498, bob_dl_LivingRoom_001_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -8231, 1036, 7300, bob_dl_Shelf_mesh),
