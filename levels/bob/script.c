...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_L1_BOOK, 5617, 186, 13010, 0, -90, 0, 0x05020000, bhvL1Book),
		OBJECT(MODEL_L1_BOOK, 5617, 186, 12960, 0, -90, 0, 0x04000000, bhvL1Book),
		OBJECT(MODEL_L1_BOOK, 5617, 186, 12909, 0, -90, 0, 0x03020000, bhvL1Book),
		OBJECT(MODEL_L1_BOOK, 5617, 288, 13010, 0, -90, 0, 0x02010000, bhvL1Book),
		OBJECT(MODEL_L1_BOOK, 5617, 288, 12960, 0, -90, 0, 0x01010000, bhvL1Book),
		OBJECT(MODEL_L1_BOOK, 5617, 288, 12909, 0, -90, 0, 0x00000000, bhvL1Book),
