...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_REMOTE, -4614, 1000, 5695, 0, 0, 0, 0x00000000, bhvRemote),
		OBJECT(MODEL_REMOTE, -6193, 0, 6612, 0, 0, 0, 0x00000000, bhvRemote),
		OBJECT(MODEL_REMOTE, -5975, 0, 8430, 0, 0, 0, 0x00000000, bhvRemote),
		OBJECT(MODEL_CUSHION, -6599, 0, 8180, 0, 0, 0, 0x00000000, bhvCushion),
