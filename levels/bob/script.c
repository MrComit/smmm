...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 1401, 365, 25614, 0, 0, 0, 0x00000000, bhvHiddenObject),
		OBJECT(MODEL_BREAKABLE_BOX, 1804, 365, 25163, 0, 0, 0, 0x00000000, bhvHiddenObject),
		OBJECT(MODEL_BREAKABLE_BOX, 1492, 365, 24567, 0, 0, 0, 0x00000000, bhvHiddenObject),
		OBJECT(MODEL_BREAKABLE_BOX, 2018, 365, 23989, 0, 0, 0, 0x00000000, bhvHiddenObject),
		OBJECT(MODEL_BREAKABLE_BOX, 1801, 365, 23089, 0, 0, 0, 0x00000000, bhvHiddenObject),
		OBJECT(MODEL_BREAKABLE_BOX, 1818, 365, 22432, 0, 0, 0, 0x00000000, bhvHiddenObject),
		...
		OBJECT(MODEL_PURPLE_SWITCH, 1017, 0, 26555, 0, 0, 0, 0x00000000, bhvFloorSwitchHiddenObjects),
		OBJECT(MODEL_RED_COIN, -880, 0, 26725, 0, 0, 0, 0x00000000, bhvRedCoin),
