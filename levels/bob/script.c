...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_REMOTE, -6837, 0, 6223, 0, 0, 0, 0x00000000, bhvRemote),
		OBJECT(MODEL_REMOTE, -8196, 1066, 7358, 0, 0, 0, 0x00000000, bhvRemote),
		OBJECT(MODEL_CUSHION, -6321, 0, 7750, 0, 17, 0, 0x00000000, bhvCushion),
		OBJECT(MODEL_CUSHION, -8480, 0, 8554, 0, -1, 0, 0x00000000, bhvCushion),
		OBJECT(MODEL_TV_STATIC, -4614, 500, 6095, 0, 0, 0, 0x00000000, bhvTVStatic),
