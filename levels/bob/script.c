...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -8776, 0, 3738, 0, 180, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_L1_GATE, 0, 0, 27228, 0, 0, 0, 0x00000000, bhvL1Gate),
		OBJECT(MODEL_L1_GATE, 4555, 0, 12698, 0, 0, 0, 0x00010000, bhvL1Gate),
		OBJECT(MODEL_L1_GATE, -8776, 0, 3648, 0, -180, 0, 0x00020000, bhvL1Gate),
		...
		OBJECT(MODEL_NONE, -1720, 277, 2698, 0, 0, 0, 0x00000000, bhvBookThrower),
		OBJECT(MODEL_NONE, -4169, 277, 2698, 0, 0, 0, 0x00000000, bhvBookThrower),
		OBJECT(MODEL_NONE, -3720, 277, 2698, 0, 0, 0, 0x00000000, bhvBookThrower),
		OBJECT(MODEL_NONE, -6969, 277, 2698, 0, 0, 0, 0x00010000, bhvBookThrower),
		OBJECT(MODEL_NONE, -2720, 277, 3479, 0, -180, 0, 0x00000000, bhvBookThrower),
		OBJECT(MODEL_NONE, -5068, 277, 3479, 0, -180, 0, 0x00000000, bhvBookThrower),
		OBJECT(MODEL_NONE, -5518, 277, 3479, 0, -180, 0, 0x00000000, bhvBookThrower),
		...
		OBJECT(MODEL_REMOTE, -7211, 0, 5679, 0, 0, 0, 0x00000000, bhvRemote),
