...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, -1842, 128, 14000, 0, -180, 0, 0x000A0000, bhvFlyingWarp),
		...
		OBJECT(MODEL_TOKEN, 227, 0, 13899, 0, 0, 0, 0x00000200, bhvToken),
		OBJECT(MODEL_TOKEN, 874, 0, 14159, 0, 0, 0, 0x00010300, bhvToken),
		OBJECT(MODEL_TOKEN, 306, 0, 14592, 0, 0, 0, 0x00020400, bhvToken),
		...
		OBJECT(MODEL_STAR_PIECE, 776, 833, 8677, 0, 0, 0, 0x02000000, bhvStarPiece),
