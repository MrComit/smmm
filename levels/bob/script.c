...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_L1_BOOK, 5617, 186, 13010, 0, -90, 0, 0x00020000, bhvL1Book),
		OBJECT(MODEL_L1_BOOK, 5617, 186, 12960, 0, -90, 0, 0x00000000, bhvL1Book),
		OBJECT(MODEL_L1_BOOK, 5617, 186, 12909, 0, -90, 0, 0x00020000, bhvL1Book),
		OBJECT(MODEL_L1_BOOK, 5617, 288, 13010, 0, -90, 0, 0x00010000, bhvL1Book),
		OBJECT(MODEL_L1_BOOK, 5617, 288, 12960, 0, -90, 0, 0x00010000, bhvL1Book),
