...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_L1_CABINET, 506, 471, 6112, 0, 0, 0, 0x00000000, bhvL1Cabinet),
		...
		OBJECT(MODEL_L1_CABINET, 506, 471, 5092, 0, 0, 0, 0x00000000, bhvL1Cabinet),
		OBJECT(MODEL_L1_CABINET, 506, 170, 6112, 0, 0, 0, 0x00000000, bhvL1Cabinet),
		OBJECT(MODEL_L1_CABINET, 506, 170, 5772, 0, 0, 0, 0x00000000, bhvL1Cabinet),
