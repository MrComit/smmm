...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_L1_BOOK, -8801, 26, 5397, 180, 0, -90, 0x00000000, bhvAppearingBook),
		OBJECT(MODEL_L1_BOOK, -8801, 91, 5917, 180, 0, -90, 0x00010000, bhvAppearingBook),
		OBJECT(MODEL_L1_BOOK, -8801, 156, 6437, 180, 0, -90, 0x00020000, bhvAppearingBook),
