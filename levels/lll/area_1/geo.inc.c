...
const GeoLayout lll_dl_102__Laundry_Room_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_aNULL_002_mesh_layer_1),
...
const GeoLayout lll_dl_b_005_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Gym_003_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Treadmill_002_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Weights_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_cNULL_003_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_cNULL_003_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_b_006_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Gym_002_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -11796, -1999, -6250, lll_dl_Pipes_002_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Treadmill_001_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Weights_001_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_cNULL_001_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_cNULL_001_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_b_007_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_ALPHA, lll_dl_Chains_001_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Gym_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -11796, -1999, -6250, lll_dl_Pipes_001_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_cNULL_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_cNULL_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_103__Gym_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_SWITCH_CASE(2, geo_switch_gym_one),
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, lll_dl_b_005_geo),
			GEO_BRANCH(1, lll_dl_cNULL_003_geo),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_aNULL_004_mesh_layer_1),
		GEO_SWITCH_CASE(2, geo_switch_gym_two),
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, lll_dl_b_006_geo),
			GEO_BRANCH(1, lll_dl_cNULL_001_geo),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_aNULL_003_mesh_layer_1),
		GEO_SWITCH_CASE(2, geo_switch_gym_three),
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, lll_dl_b_007_geo),
			GEO_BRANCH(1, lll_dl_cNULL_geo),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_aNULL_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Bench_001_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -4034, 105, 547, 90, 0, 0, lll_dl_Dumbbell_003_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Locker_002_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_Weights_002_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
...
const GeoLayout lll_dl_104__Wine_Cellar_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_ASM(9, geo_update_vanish_floor),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_MUSICFLOOR_Cellar_mesh_layer_1),
...
const GeoLayout lll_dl_b_003_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_EngineRoom_007_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_EngineRoom_008_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_cNULL_006_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_cNULL_006_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_b_008_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_EngineRoom_004_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_EngineRoom_005_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_EngineRoom_006_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, lll_dl_EngineRoom_006_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 9977, 452, 439, lll_dl_Pillars_001_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_cNULL_004_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_cNULL_004_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_b_009_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_EngineRoom_009_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_EngineRoom_010_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_cNULL_005_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_cNULL_005_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_dl_107__Engine_Room_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_SWITCH_CASE(2, geo_switch_engine_first),
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, lll_dl_b_003_geo),
			GEO_BRANCH(1, lll_dl_cNULL_006_geo),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_aNULL_005_mesh_layer_1),
		GEO_SWITCH_CASE(2, geo_switch_engine_middle),
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, lll_dl_b_008_geo),
			GEO_BRANCH(1, lll_dl_cNULL_004_geo),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_aNULL_006_mesh_layer_1),
		GEO_SWITCH_CASE(2, geo_switch_engine_last),
		GEO_OPEN_NODE(),
			GEO_BRANCH(1, lll_dl_b_009_geo),
