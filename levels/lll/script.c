...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		INSTANT_WARP(0, 0x01, 13, 610, 3923),
		INSTANT_WARP(1, 0x01, 996, 296, 11004),
		INSTANT_WARP(2, 0x01, -1309, 163, 9054),
		INSTANT_WARP(3, 0x01, 187, -552, -3923),
		...
		OBJECT(MODEL_LAUNDRY_BOUNCE_BOX, 5098, -271, 16329, 0, -180, 0, (2 << 24) | (10 << 16), bhvBounceBoxes),
		...
		OBJECT(MODEL_BASEMENT_DRYER, 13126, 1131, 11520, 0, -180, 0, 0x00000000, bhvBasementDryer),
		OBJECT(MODEL_BASEMENT_DRYER, 9751, 0, 4244, 0, 90, 0, 0x00000000, bhvBasementDryer),
		...
		OBJECT(MODEL_BASEMENT_WASHER, 13109, 1131, 11961, 0, 0, 0, 0x00000000, bhvBasementWasher),
		OBJECT(MODEL_BASEMENT_WASHER, 11128, 0, 6466, 0, -90, 0, 0x00000000, bhvBasementWasher),
