...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		WARP_NODE(0xA4, LEVEL_SSL, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_ELEVATOR_DOOR, 500, -3000, -10287, 0, 0, 0, (3 << 16) | (0xAC << 8), bhvElevatorDoor),
		...
		OBJECT(MODEL_BOO, 8040, 0, 8679, 0, 0, 0, (6 << 24) | (0x13 << 16), bhvRoomBoo),
		OBJECT(MODEL_NONE, 8040, 0, 8679, 0, -90, 0, 0x00000000, bhvBasementSwitchSpawn),
		OBJECT(MODEL_TOKEN, 12746, 448, 7132, 0, -103, 0, (0 << 16) | (0x2F << 8), bhvToken),
		OBJECT(MODEL_TOKEN, 4362, 15, 4388, 0, 90, 0, (1 << 16) | (0x2B << 8), bhvToken),
		...
		OBJECT(MODEL_GLOBAL_GATE, 3269, 0, 5963, 0, 90, 0, 0x00000000, bhvGlobalGate),
		...
		OBJECT(MODEL_TOKEN, -5807, 2211, -10853, 0, 0, 0, (1 << 16) | (0x31 << 8), bhvToken),
		OBJECT(MODEL_TOKEN, -3922, 2256, -4183, 0, 0, 0, (1 << 16) | (0x32 << 8), bhvToken),
		...
		OBJECT(MODEL_ENGINE_GEAR, 6575, 402, 1308, 0, 0, 0, (1 << 24) | (6 << 16), bhvEngineGear),
		OBJECT(MODEL_ENGINE_GEAR, 5906, 305, 2274, 0, 0, 0, (1 << 24) | (6 << 16), bhvEngineGear),
		OBJECT(MODEL_ENGINE_GEAR, 5249, 228, 1182, 0, 0, 0, (1 << 24) | (6 << 16), bhvEngineGear),
		OBJECT(MODEL_ENGINE_GEAR, 4304, 0, 1812, 0, 0, 0, (1 << 24) | (6 << 16), bhvEngineGear),
		...
		OBJECT(MODEL_TOKEN, 2829, 1442, -462, 0, -180, 0, (1 << 16) | (0x30 << 8), bhvToken),
		...
		OBJECT(MODEL_JOURNAL_BOOK, 1087, -3520, -7643, 0, 0, 0, (DIALOG_055 << 16), bhvJournalBook),
		OBJECT(MODEL_WOODEN_SIGNPOST, 300, -3520, -7082, 0, -180, 0, (DIALOG_063 << 16), bhvPortalWarning),
