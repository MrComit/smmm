...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_TELEPORTER, 8744, -1894, -13252, 0, -90, 0, (0x33 << 16), bhvFadingWarp),
		...
		OBJECT(MODEL_SHYGUY, 8944, 100, -2948, 0, -180, 0, 0x00000000, bhvJSShyguyManager),
		...
		OBJECT(MODEL_BASEMENT_SWITCH, 8744, -1894, -12757, 0, 0, 0, (4 << 16), bhvBasementSwitch),
