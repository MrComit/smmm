...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_DUST_BUNNY, 4822, -271, 17012, 0, -180, 0, 0x00000000, bhvDustBunny),
		OBJECT(MODEL_DUST_BUNNY, 5242, -271, 15559, 0, -180, 0, (2 << 24) | (10 << 16), bhvDustBunny),
		OBJECT(MODEL_GOOMBA, 5994, -271, 16518, 0, -180, 0, (1 << 16), bhvGoomba),
