...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_SECURITY_CAM, -879, 1666, 6932, 0, 0, 0, 0x00000000, bhvSecurityCam),
		...
		OBJECT(MODEL_BOO_COIN, -6982, 0, 5930, 0, 90, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_BOO_COIN, -7023, 0, 5256, 0, 90, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_BOO_COIN, -7065, 0, 4593, 0, 90, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_BOO_COIN, -7063, 0, 4017, 0, 90, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_BOO_COIN, -4978, 0, 6162, 0, 90, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_HAUNTED_CAGE, -5792, 0, 4713, 0, 90, 0, (2 << 16) | (0x13 << 8), bhvBooCoinCage),
		OBJECT(MODEL_BREAKABLE_BOX, -4978, 0, 6162, 0, 90, 0, 0x00000000, bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -4978, 500, 6162, 0, 90, 0, 0x00000000, bhvBreakableBox),
