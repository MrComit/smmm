...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_NONE, -7147, 733, -6007, 0, 0, 0, 0x00000000, bhvHorizontalPoleNoCol),
		OBJECT(MODEL_NONE, -7147, 1445, -6007, 0, 0, 0, 0x00000000, bhvHorizontalPoleNoCol),
		OBJECT(MODEL_NONE, -7147, 1042, -6649, 0, -180, 0, 0x00000000, bhvHorizontalPoleNoCol),
		OBJECT(MODEL_NONE, -7147, 1754, -6649, 0, -180, 0, 0x00000000, bhvHorizontalPoleNoCol),
