...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_GRAVITY_BUTTON, 14874, 500, 2888, 0, -180, 0, 0x00000000, bhvGravityButton),
		OBJECT(MODEL_GRAVITY_BUTTON, 11549, 500, 3188, 0, -180, 0, 0x00000000, bhvGravityButton),
		OBJECT(MODEL_GRAVITY_BUTTON, 15624, 500, -1187, 0, -90, 0, 0x00000000, bhvGravityButton),
		...
		OBJECT(MODEL_THWOMP_BLOCK, 13749, -400, 2513, 0, 0, 0, (15 << 16), bhvThwompBlock),
		OBJECT(MODEL_THWOMP_BLOCK, 8874, -400, -1187, 0, 0, 0, (15 << 16), bhvThwompBlock),
		OBJECT(MODEL_THWOMP_BLOCK, 11549, 350, 2513, 0, 0, 0, (1 << 24) | (7 << 16), bhvThwompBlock),
		OBJECT(MODEL_THWOMP_BLOCK, 13749, -400, 1063, 0, 0, 0, (15 << 16), bhvThwompBlock),
		OBJECT(MODEL_THWOMP_BLOCK, 12624, -400, -1187, 0, 0, 0, (15 << 16), bhvThwompBlock),
		OBJECT(MODEL_THWOMP_BLOCK, 9499, 350, 1063, 0, 0, 0, (1 << 24) | (7 << 16), bhvThwompBlock),
