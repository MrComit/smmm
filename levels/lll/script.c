...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_THWOMP_BLOCK, 13249, -400, 3113, 0, 0, 0, (15 << 16), bhvThwompBlock),
		...
		OBJECT(MODEL_THWOMP_BLOCK, 13249, -400, 1013, 0, 0, 0, (15 << 16), bhvThwompBlock),
		OBJECT(MODEL_THWOMP_BLOCK, 12499, -400, 3113, 0, 0, 0, (15 << 16), bhvThwompBlock),
		...
		OBJECT(MODEL_THWOMP_BLOCK, 11749, -400, 3113, 0, 0, 0, (15 << 16), bhvThwompBlock),
		OBJECT(MODEL_THWOMP_BLOCK, 8999, 650, 263, 0, 0, 0, (1 << 24) | (7 << 16), bhvThwompBlock),
		OBJECT(MODEL_THWOMP_BLOCK, 10999, -400, 3113, 0, 0, 0, (15 << 16), bhvThwompBlock),
		OBJECT(MODEL_THWOMP_BLOCK, 12499, -400, 263, 0, 0, 0, (15 << 16), bhvThwompBlock),
