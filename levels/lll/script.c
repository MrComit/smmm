...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_NONE, -250, -2750, -13387, 0, 0, 0, 0x00000000, bhvSawbladeSpawn),
		OBJECT(MODEL_NONE, 1250, -2750, -13387, 0, 0, 0, 0x00000000, bhvSawbladeSpawn),
		OBJECT(MODEL_NONE, 500, -2750, -13387, 0, 0, 0, 0x00000000, bhvSawbladeSpawn),
