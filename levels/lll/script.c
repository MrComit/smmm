...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 500, -3000, -13437, 0, -90, 0, 0x00000000, bhvBreakableBox),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 500, 0, -10837, 0, 0, 0, 0x00000000, bhvDoor),
		...
		OBJECT(MODEL_DUST_BUNNY, -420, -3000, -12445, 0, -180, 0, (2 << 16), bhvDustBunny),
		OBJECT(MODEL_DUST_BUNNY, 1364, -3000, -12395, 0, -180, 0, (2 << 16), bhvDustBunny),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 500, -3000, -10837, 0, 0, 0, 0x00000000, bhvDoor),
		...
		OBJECT(MODEL_NONE, 829, -3000, -12493, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_NONE, -250, -2800, -13387, 0, 0, 0, 0x00000000, bhvSawbladeSpawn),
		OBJECT(MODEL_NONE, 1250, -2800, -13387, 0, 0, 0, 0x00000000, bhvSawbladeSpawn),
		...
		OBJECT(MODEL_WALL_GOOMBA, -49, -3000, -13397, 0, 0, 0, 0x00000000, bhvWallGoomba),
		OBJECT(MODEL_WALL_GOOMBA, 192, -3000, -13397, 0, 0, 0, 0x00000000, bhvWallGoomba),
		OBJECT(MODEL_WALL_GOOMBA, -646, -3000, -13397, 0, 0, 0, 0x00000000, bhvWallGoomba),
		OBJECT(MODEL_WALL_HAMMERBRO, -406, -3000, -13397, 0, 0, 0, 0x00000000, bhvWallHammerBro),
