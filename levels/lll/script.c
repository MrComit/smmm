...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_BASEMENT_DRYER, 13073, 0, 12059, 0, 0, 0, 0x00000000, bhvBasementDryer),
		OBJECT(MODEL_BASEMENT_DRYER, 10195, 168, 4236, 0, 0, 0, 0x00000000, bhvBasementDryer),
		...
		OBJECT(MODEL_BASEMENT_WASHER, 13073, 0, 11410, 0, -180, 0, 0x00000000, bhvBasementWasher),
		OBJECT(MODEL_BASEMENT_WASHER, 11146, 168, 6511, 0, -180, 0, 0x00000000, bhvBasementWasher),
