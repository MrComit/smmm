...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_SWINGING_PLAT, 5651, 482, -5335, 0, 45, 0, 0x00000000, bhvSwingingPlat),
		OBJECT(MODEL_NONE, 7975, 227, -6868, 0, -90, 0, 0x00000000, bhvSawbladeSpawn),
		OBJECT(MODEL_NONE, 7514, 227, -2928, 0, -135, 0, 0x00000000, bhvSawbladeSpawn),
		OBJECT(MODEL_SAWBLADE, 7079, 227, -4170, 0, 0, 0, 0x00000000, bhvSawbladeMove),
