...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_SWINGING_PLAT, 3966, 482, -4263, 0, 90, 0, 0x00000000, bhvSwingingPlat),
		OBJECT(MODEL_SWINGING_PLAT, 5651, 482, -4774, 0, 0, 0, 0x00000000, bhvSwingingPlat),
		OBJECT(MODEL_SWINGING_PLAT, 7987, 482, -11269, 0, -180, 0, 0x00000000, bhvSwingingPlat),
		OBJECT(MODEL_SWINGING_PLAT, 8012, 482, -9490, 0, -90, 0, 0x00000000, bhvSwingingPlat),
		OBJECT(MODEL_SWINGING_PLAT, 7638, 482, -8076, 0, 90, 0, 0x00000000, bhvSwingingPlat),
		...
		OBJECT(MODEL_SAWBLADE, 2807, 100, -10812, 0, 51, 0, (1 << 16), bhvSawbladeMove),
		OBJECT(MODEL_SAWBLADE, 6511, 100, -12216, 0, 47, 0, (1 << 16), bhvSawbladeMove),
