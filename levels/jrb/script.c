...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_DIRT_MOUND, 404, -488, 2794, 0, 0, 0, 0x00000000, bhvDirtMound),
		...
		OBJECT(MODEL_DIRT_MOUND, -5267, -488, 955, 0, 0, 0, 0x00000000, bhvDirtMound),
		...
		OBJECT(MODEL_BLUE_COIN, -2004, -3637, -2372, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -1167, -3637, -2955, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -2696, -3732, -4061, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -1566, -3701, -4841, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -1979, -3732, -3784, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -897, -3657, -5413, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN_SWITCH, -1681, -3591, -1157, 0, 0, 0, 0x0C021000, bhvBlueCoinSwitch),
