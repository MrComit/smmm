...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_PIRANHA_PLANT, -5193, 782, 9648, 0, 0, 0, 0x00000000, bhvDarkPiranha),
		OBJECT(MODEL_PIRANHA_PLANT, -1742, -488, 5962, 0, 0, 0, 0x00000000, bhvDarkPiranha),
		OBJECT(MODEL_PIRANHA_PLANT, -2287, -488, 5080, 0, 0, 0, 0x00000000, bhvDarkPiranha),
		OBJECT(MODEL_PIRANHA_PLANT, -2507, -488, 5697, 0, 0, 0, 0x00000000, bhvDarkPiranha),
		OBJECT(MODEL_PIRANHA_PLANT, -1593, -488, 9993, 0, 0, 0, 0x00000000, bhvDarkPiranha),
		OBJECT(MODEL_PIRANHA_PLANT, -4303, -488, 8570, 0, 0, 0, 0x00000000, bhvDarkPiranha),
