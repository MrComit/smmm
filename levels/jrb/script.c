...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_PIRANHA_PLANT, -3353, -488, 10273, 0, 0, 0, 0x00000000, bhvDarkPiranha),
		OBJECT(MODEL_PIRANHA_PLANT, -1605, -488, 10149, 0, 0, 0, 0x00000000, bhvDarkPiranha),
		OBJECT(MODEL_PIRANHA_PLANT, -1599, -488, 5242, 0, 0, 0, 0x00000000, bhvDarkPiranha),
