...
const GeoLayout jrb_dl_104__Conservatory_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, -5697, -431, 6298, jrb_dl_Pot_004_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(4, -5223, -428, 7105, jrb_dl_Shrub_004_mesh_layer_4),
		GEO_TRANSLATE_NODE_WITH_DL(1, -4460, -235, 6345, jrb_dl_Sun_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(5, jrb_dl_Sun_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(5, -2848, -388, 6247, jrb_dl_Sunblock_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(1, -5697, -432, 6298, jrb_dl_Sunflower_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, -4462, -380, 6362, jrb_dl_Table_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
