...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_NONE, -10379, 200, 433, 0, 0, 0, 0x001A0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -10379, 200, 433, 0, 0, 0, 0x000A0000, bhvFlyingWarp),
		MARIO_POS(0x01, 0, -10379, 200, 433),
