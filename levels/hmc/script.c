...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_NONE, -6160, 300, -7356, -5, -90, 5, (0x1A << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -6160, 300, -7356, -5, -90, 5, (0xA << 16), bhvFlyingWarp),
		MARIO_POS(0x01, -90, -6160, 300, -7356),
