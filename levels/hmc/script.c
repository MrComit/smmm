...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_NONE, -8503, 300, 11377, -2, 90, -2, (0xA << 16), bhvFlyingWarp),
		MARIO_POS(0x01, 90, -8503, 300, 11377),
		...
		OBJECT(MODEL_TROPHY_RECTANGLE, -2636, -100, 12290, 0, -160, 0, (32 << 24) | (3 << 16), bhvTrophyRect),
	...
	AREA(2, hmc_area_2),
		...
		OBJECT(MODEL_TOKEN, 785, 2186, -17599, 0, 97, 0, (0x19 << 8), bhvToken),
