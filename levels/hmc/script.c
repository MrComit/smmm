...
const LevelScript level_hmc_entry[] = {
	...
	AREA(2, hmc_area_2),
		...
		OBJECT(MODEL_BLUE_OWL, 1987, 515, -11107, 0, -43, 0, 0x00000000, bhvBlueOwl),
		OBJECT(MODEL_BLUE_OWL, -1030, 515, -11857, 0, 51, 0, 0x00000000, bhvBlueOwl),
		...
		OBJECT(MODEL_TIGHT_ROPE, 487, -74, 5246, 0, 0, 0, (100 << 16), bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, 221, -24, -7422, 0, 0, 0, 0x00000000, bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, 285, -224, 8208, 0, 0, 0, (40 << 16), bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, -45, -24, -8891, 0, 15, 0, 0x00000000, bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, -460, -24, -10532, 0, -30, 0, 0x00000000, bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, 482, -24, -11939, 0, 15, 0, 0x00000000, bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, -159, -24, -13518, 0, 0, 0, 0x00000000, bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, 285, -224, 2656, 0, 0, 0, (40 << 16), bhvTightRope),
		...
		OBJECT(MODEL_TREE_LIMB, 1216, -242, -4661, 0, 90, 0, 0x00000000, bhvTreeLimb),
		OBJECT(MODEL_TREE_LIMB, -784, -392, -461, 0, -90, 0, 0x00000000, bhvTreeLimb),
