...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_STAR_PIECE, 9483, 150, 9011, 0, 0, 0, (0x10 << 24), bhvStarPiece),
		OBJECT(MODEL_TOY_MOLE, 9483, 100, 9011, 0, 0, 0, 0x00000000, bhvToyMole),
		OBJECT(MODEL_TOY_MOLE, 8858, 100, 8698, 0, 32, 0, 0x00000000, bhvToyMole),
		OBJECT(MODEL_TOY_MOLE, 8858, 100, 9011, 0, 45, 0, 0x00000000, bhvToyMole),
		OBJECT(MODEL_TOY_MOLE, 9171, 100, 8386, 0, -14, 0, 0x00000000, bhvToyMole),
