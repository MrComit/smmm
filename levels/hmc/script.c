...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_NONE, 3082, 200, 14012, 0, 90, 0, 0x001A0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -10581, 200, 2363, 0, 0, 0, 0x000A0000, bhvFlyingWarp),
		OBJECT(MODEL_NONE, 3082, 200, 14012, 0, 90, 0, 0x000A0000, bhvFlyingWarp),
		MARIO_POS(0x01, 0, -10581, 200, 2363),
		MARIO_POS(0x01, 90, 3082, 200, 14012),
