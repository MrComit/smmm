...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_NONE, 1513, 200, -7509, 0, -180, 0, (0x1A << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -10581, -2363, 200, 90, 0, 0, (0xA << 16), bhvFlyingWarp),
		OBJECT(MODEL_NONE, 1513, 200, -7509, 0, -180, 0, (0xA << 16), bhvFlyingWarp),
		MARIO_POS(0x01, 0, -10581, -2363, 200),
		MARIO_POS(0x01, -180, 1513, 200, -7509),
	...
	AREA(2, hmc_area_2),
		...
		OBJECT(MODEL_TREEHOUSE_SPIKE, 2291, 933, -21832, 0, -90, 0, 0x00000000, bhvSpike),
		OBJECT(MODEL_SWOOP, -3129, 2658, -22720, 0, -90, 0, 0x00000000, bhvSwoop),
		OBJECT(MODEL_SWOOP, -2435, 2658, -21546, 0, -90, 0, 0x00000000, bhvSwoop),
		OBJECT(MODEL_SWOOP, -2785, 2658, -21215, 0, -90, 0, 0x00000000, bhvSwoop),
		OBJECT(MODEL_TREE_LIMB, -19, 868, -23142, 0, -180, 0, 0x00000000, bhvTreeLimb),
