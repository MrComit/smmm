...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_DICE_ENEMY, 7180, 0, 6104, 0, -90, 0, 0x00000000, bhvDiceEnemy),
		OBJECT(MODEL_DICE_ENEMY, 7182, 0, 6236, 0, -90, 0, (1 << 16), bhvDiceEnemy),
		OBJECT(MODEL_DICE_ENEMY, 7177, 0, 6353, 0, -90, 0, (2 << 16), bhvDiceEnemy),
		OBJECT(MODEL_DICE_ENEMY, 7169, 0, 6491, 0, -90, 0, (3 << 16), bhvDiceEnemy),
		OBJECT(MODEL_DICE_ENEMY, 7167, 0, 6635, 0, -90, 0, (4 << 16), bhvDiceEnemy),
		OBJECT(MODEL_DICE_ENEMY, 7177, 0, 6771, 0, -90, 0, (5 << 16), bhvDiceEnemy),
