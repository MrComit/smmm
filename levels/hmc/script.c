...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_GOOMBA_2D, -3790, 100, -11146, 0, -90, 0, 0x00000000, bhv2DEnemy),
		OBJECT(MODEL_GOOMBA_2D, -3424, 100, -11146, 0, -90, 0, 0x00000000, bhv2DEnemy),
		OBJECT(MODEL_GOOMBA_2D, -3126, 100, -11146, 0, -90, 0, 0x00000000, bhv2DEnemy),
		OBJECT(MODEL_GOOMBA_2D, -5125, 782, -11146, 0, -90, 0, 0x00000000, bhv2DEnemy),
		OBJECT(MODEL_GOOMBA_2D, -4890, 782, -11146, 0, -90, 0, 0x00000000, bhv2DEnemy),
		OBJECT(MODEL_KOOPA_2D, -3790, 970, -11146, 0, -90, 0, 0x00000000, bhv2DEnemy),
		OBJECT(MODEL_KOOPA_2D, -3485, 970, -11146, 0, -90, 0, 0x00000000, bhv2DEnemy),
		OBJECT(MODEL_KOOPA_2D, -3211, 970, -11146, 0, -90, 0, 0x00000000, bhv2DEnemy),
