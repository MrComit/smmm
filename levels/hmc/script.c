...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_BULLY, -6215, 2800, -3918, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_BULLY, -7160, 2712, -2186, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_SAUNA_GRATE, -4894, 2400, -3981, 0, -90, 0, 0x00000000, bhvSaunaGrate),
		OBJECT(MODEL_SAUNA_GRATE, -6215, 2400, -3918, 0, -90, 0, 0x00000000, bhvSaunaGrate),
		OBJECT(MODEL_SAUNA_GRATE, -3332, 2500, -4074, 0, -90, 0, (1 << 16), bhvSaunaGrate),
