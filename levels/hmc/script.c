...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_NONE, 3579, 200, 12469, 0, 90, 0, (0x1A << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -10581, -2363, 200, 90, 0, 0, (0xA << 16), bhvFlyingWarp),
		OBJECT(MODEL_NONE, 3579, 200, 12469, 0, 90, 0, (0xA << 16), bhvFlyingWarp),
		MARIO_POS(0x01, 0, -10581, -2363, 200),
		MARIO_POS(0x01, 90, 3579, 200, 12469),
		...
		OBJECT(MODEL_MUSIC_INSTS, 12718, 0, 18172, 0, -90, 0, 0x00000000, bhvMusicInsts),
		OBJECT(MODEL_MUSIC_INSTS, 6061, 0, 17457, 0, -180, 0, (1 << 16), bhvMusicInsts),
		OBJECT(MODEL_MUSIC_INSTS, 11015, 0, 13265, 0, -90, 0, (2 << 16), bhvMusicInsts),
		OBJECT(MODEL_MUSIC_INSTS, 6790, 0, 9944, 0, -45, 0, (3 << 16), bhvMusicInsts),
		OBJECT(MODEL_SHYGUY, 13124, 75, 14420, 0, -90, 0, 0x00000000, bhvMusicShyguy),
