...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_NONE, 1122, 250, 3294, 0, -180, 0, (0x1A << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -10581, -2363, 200, 90, 0, 0, (0xA << 16), bhvFlyingWarp),
		OBJECT(MODEL_NONE, 1122, 250, 3294, 0, -180, 0, (0xA << 16), bhvFlyingWarp),
		MARIO_POS(0x01, 0, -10581, -2363, 200),
		MARIO_POS(0x01, -180, 1122, 250, 3294),
