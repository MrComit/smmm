...
const LevelScript level_hmc_entry[] = {
	...
	AREA(2, hmc_area_2),
		...
		OBJECT(MODEL_TIGHT_ROPE, -375, -524, -422, 0, 0, 0, 0x00000000, bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, 285, -224, 8408, 0, 0, 0, (20 << 16), bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, -45, -524, -1891, 0, 15, 0, 0x00000000, bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, -460, -524, -3532, 0, -30, 0, 0x00000000, bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, 482, -524, -4939, 0, 15, 0, 0x00000000, bhvTightRope),
		OBJECT(MODEL_TIGHT_ROPE, -159, -524, -6518, 0, 0, 0, 0x00000000, bhvTightRope),
		...
		OBJECT(MODEL_TREE_LIMB, 1216, -392, 1639, 0, 90, 0, 0x00000000, bhvTreeLimb),
		OBJECT(MODEL_TREE_LIMB, -784, -392, 5839, 0, -90, 0, 0x00000000, bhvTreeLimb),
