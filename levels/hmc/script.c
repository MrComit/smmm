...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_ENV_FLAME, -2079, 5185, 11388, 0, -90, 0, 0x00000000, bhvAtticMovingFlame),
		OBJECT(MODEL_ENV_FLAME, -4079, 5185, 12388, 0, -90, 0, 0x00000000, bhvAtticMovingFlame),
		OBJECT(MODEL_ENV_FLAME, -3079, 5185, 9388, 0, -90, 0, 0x00000000, bhvAtticMovingFlame),
		...
		OBJECT(MODEL_ATTIC_SPIKE, -4579, 5185, 9888, 0, -90, 0, 0x00000000, bhvAtticSpike),
		OBJECT(MODEL_ATTIC_ROCK, -3579, 5185, 9888, 0, -90, 0, 0x00000000, bhvAtticRock),
		OBJECT(MODEL_ATTIC_GRATE, -2579, 5185, 9888, 0, -90, 0, 0x00000000, bhvAtticGrate),
		OBJECT(MODEL_ATTIC_ROCK, -1579, 5185, 9888, 0, -90, 0, 0x00000000, bhvAtticRock),
		...
		OBJECT(MODEL_ATTIC_GRATE, -2579, 5185, 10888, 0, -90, 0, 0x00000000, bhvAtticGrate),
		OBJECT(MODEL_ATTIC_GRATE, -1579, 5185, 10888, 0, -90, 0, 0x00000000, bhvAtticGrate),
		OBJECT(MODEL_ATTIC_SPIKE, -579, 5185, 10888, 0, -90, 0, 0x00000000, bhvAtticSpike),
		OBJECT(MODEL_ATTIC_GRATE, -4579, 5185, 11888, 0, -90, 0, 0x00000000, bhvAtticGrate),
		OBJECT(MODEL_ATTIC_ROCK, -3579, 5185, 11888, 0, -90, 0, 0x00000000, bhvAtticRock),
		OBJECT(MODEL_ATTIC_SPIKE, -2579, 5185, 11888, 0, -90, 0, 0x00000000, bhvAtticSpike),
		OBJECT(MODEL_ATTIC_ROCK, -1579, 5185, 11888, 0, -90, 0, 0x00000000, bhvAtticRock),
