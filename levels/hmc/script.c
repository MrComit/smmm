...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_NONE, -6898, 200, -7210, 0, -90, 0, (0x1A << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -10581, 200, 2363, 0, 0, 0, (0xA << 16), bhvFlyingWarp),
		OBJECT(MODEL_NONE, -6898, 200, -7210, 0, -90, 0, (0xA << 16), bhvFlyingWarp),
		MARIO_POS(0x01, 0, -10581, 200, 2363),
		MARIO_POS(0x01, -90, -6898, 200, -7210),
		...
		OBJECT(MODEL_STAR_PIECE, -18795, -150, -7200, 0, 0, 0, (0x12 << 24), bhvStarPiece),
