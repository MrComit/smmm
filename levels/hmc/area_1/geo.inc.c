...
const GeoLayout hmc_dl_104__Music_Room_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 6739, 172, 18455, 0, -180, 0, hmc_dl_Drums_mesh_layer_1),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 10587, 105, 10474, 90, 0, 45, hmc_dl_Piano_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 12922, 0, 14753, 90, 0, 90, hmc_dl_RecordPlayer_mesh_layer_1),
		GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 4291, 297, 9890, -180, 0, 0, hmc_dl_Violin_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
