...
const GeoLayout hmc_dl_101__OpeningHall_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_Lamp_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_Side_Table_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_Side_Table_002_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, hmc_dl_SpiderWeb_003_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, hmc_dl_Stairs_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 2166, 218, -6663, hmc_dl_Vase_003_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
