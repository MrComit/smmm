...
void scroll_hmc_dl_TrophyRoom_007_mesh_layer_1_vtx_3() {
	int i = 0;
	int count = 6;
	int width = 64 * 0x20;
	int height = 32 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(hmc_dl_TrophyRoom_007_mesh_layer_1_vtx_3);
...
void scroll_hmc_dl_TrophyRoom_007_mesh_layer_1_vtx_4() {
	int i = 0;
	int count = 6;
	int width = 64 * 0x20;
	int height = 32 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(hmc_dl_TrophyRoom_007_mesh_layer_1_vtx_4);
...
void scroll_hmc_dl_Sauna_mesh_layer_1_vtx_7() {
	int i = 0;
	int count = 36;
	int width = 32 * 0x20;
	int height = 32 * 0x20;
	...
	float offsetY = 32.0;
	Vtx *vertices = segmented_to_virtual(hmc_dl_Sauna_mesh_layer_1_vtx_7);
...
void scroll_hmc_dl_Steam_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 32;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(hmc_dl_Steam_mesh_layer_5_vtx_0);
...
void scroll_hmc() {
	...
	scroll_hmc_dl_TrophyRoom_007_mesh_layer_1_vtx_3();
