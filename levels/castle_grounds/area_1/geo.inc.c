...
const GeoLayout castle_grounds_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -45, 0, 13043),
		GEO_OPEN_NODE(),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 1089, 2169, -8950, castle_grounds_dl_Mansion_mesh_layer_1),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_Mansion_mesh_layer_4),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 1128, -2761, -3126, castle_grounds_dl_Mansion_001_mesh_layer_1),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 5044, 8865, -3835, castle_grounds_dl_Tree_Leaves_mesh_layer_4),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 4541, 2513, -3156, castle_grounds_dl_Trees_mesh_layer_1),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
