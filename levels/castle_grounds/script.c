...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_DIRT_PILE, -2760, -2761, -8262, 0, 0, 0, (23 << 16), bhvDirtPile),
		OBJECT(MODEL_DIRT_PILE, -1389, -2719, -5849, 0, 0, 0, (24 << 16), bhvDirtPile),
		OBJECT(MODEL_DIRT_PILE, 3592, -2761, -15381, 0, 0, 0, (25 << 16), bhvDirtPile),
		OBJECT(MODEL_DIRT_PILE, 2423, -2761, -12961, 0, 0, 0, (26 << 16), bhvDirtPile),
		OBJECT(MODEL_DIRT_PILE, -2979, -2761, -16419, 0, 0, 0, (27 << 16), bhvDirtPile),
