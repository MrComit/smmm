...
const GeoLayout ccm_dl_101__City_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ccm_dl_CBWall3_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ccm_dl_Rack_003_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ccm_dl_ShoeShelf_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, ccm_dl_ShoeShelf_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ccm_dl_ShoeShelf_001_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, ccm_dl_ShoeShelf_001_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_ALPHA, ccm_dl_ShoeShelf_002_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, ccm_dl_Signs_mesh_layer_6),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ccm_dl_Slingshot_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ccm_dl_Table_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
