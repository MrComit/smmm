...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_LEGO_PIECE, 7283, 1229, -4515, 90, -180, 0, 0x00000000, bhvLegoPiece),
		...
		OBJECT(MODEL_STAR_CURRENCY, 24026, 5111, -9938, 0, 90, 0, 0x00000000, bhvStar),
		...
		OBJECT(MODEL_HORIZONTAL_POLE, 12570, 89, -4915, 0, 90, 0, 0x00100000, bhvHorizontalPole),
		...
		OBJECT(MODEL_PURPLE_SWITCH, 13070, -161, -5826, 0, -90, 0, 0x00000000, bhvGenericSwitch),
