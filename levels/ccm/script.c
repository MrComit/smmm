...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_NONE, 20392, 6139, -12994, 0, 0, 0, 0x000C0000, bhvFlyingWarp),
		...
		OBJECT(MODEL_LEGO_PIECE, 7283, 1829, -4515, -90, 0, 0, 0x00020000, bhvLegoPiece),
		...
		OBJECT(MODEL_LEGO_PIECE, 7283, 2729, -4115, 0, 0, 0, 0x00020000, bhvLegoPiece),
		...
		OBJECT(MODEL_LEGO_PIECE, 7283, 1329, -5315, 90, 0, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 7283, 2629, -4515, -90, 0, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 7283, 2129, -5315, 90, 0, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 8783, 129, -4915, 0, -180, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 7283, 2929, -5315, 90, 0, 0, 0x00020000, bhvLegoPiece),
		...
		OBJECT(MODEL_LEGO_PIECE, 7283, 1029, -4515, -90, 0, 0, 0x00020000, bhvLegoPiece),
		...
		OBJECT(MODEL_NONE, 21242, -161, 1616, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		...
		OBJECT(MODEL_SAVE_STATION, 22815, -161, -8727, 0, 0, 0, 0x00000000, bhvSaveStation),
		...
		OBJECT(MODEL_TOY_TOAD, 6283, 379, -2473, 0, -135, 0, (DIALOG_065 << 24), bhvToyToad),
		OBJECT(MODEL_TOY_TOAD, 3654, 379, 1929, 0, 120, 0, (DIALOG_104 << 24), bhvToyToad),
		...
		SET_BACKGROUND_MUSIC(0x00, SEQ_CITY),
	...
	AREA(2, ccm_area_2),
		...
		OBJECT(MODEL_NONE, 21861, 39, 0, 0, -90, 0, 0x001a0000, bhvAirborneDeathWarp),
		...
		OBJECT(MODEL_HORIZONTAL_POLE, 5534, 1058, 6041, 0, -135, 0, 0x00100000, bhvHorizontalPole),
