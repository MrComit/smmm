...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_HORIZONTAL_POLE, 4166, 629, 7410, 0, 0, 0, 0x00100000, bhvHorizontalPole),
		OBJECT(MODEL_HORIZONTAL_POLE, 19759, 1511, 2863, 0, 0, 0, 0x00100000, bhvHorizontalPole),
