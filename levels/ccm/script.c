...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_NONE, -8743, 779, 8304, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
	...
	AREA(2, ccm_area_2),
		...
		OBJECT(MODEL_LEGO_PIECE, -5292, 4689, 2026, 0, -90, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, -6689, 4889, 2026, 0, 0, 0, 0x00020000, bhvLegoPiece),
