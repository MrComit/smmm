...
const LevelScript level_ccm_entry[] = {
	...
	AREA(2, ccm_area_2),
		...
		OBJECT(MODEL_NONE, -7539, 5239, 660, 0, 90, 0, (1 << 16), bhvBossBulletBillCannon),
		OBJECT(MODEL_NONE, -7539, 5239, 60, 0, 90, 0, (1 << 16), bhvBossBulletBillCannon),
		OBJECT(MODEL_NONE, -14839, 5757, -10331, 0, 90, 0, (2 << 16), bhvBossBulletBillCannon),
