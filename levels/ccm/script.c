...
const LevelScript level_ccm_entry[] = {
	...
	AREA(2, ccm_area_2),
		...
		OBJECT(MODEL_BLOCK_TOWER, -13208, 5964, 1075, 0, -90, 0, 0x00000000, bhvBlockTower),
		OBJECT(MODEL_BLOCK_TOWER, -11994, 7366, -5322, 0, -90, 0, 0x00000000, bhvBlockTower),
		OBJECT(MODEL_NONE, -7589, 5577, 506, 0, 90, 0, (1 << 16), bhvBossBulletBillCannon),
		OBJECT(MODEL_NONE, -7589, 5577, -37, 0, 90, 0, (1 << 16), bhvBossBulletBillCannon),
		OBJECT(MODEL_NONE, -7589, 5577, -1597, 0, 90, 0, (1 << 16), bhvBossBulletBillCannon),
		OBJECT(MODEL_NONE, -7589, 5577, -2979, 0, 90, 0, (1 << 16), bhvBossBulletBillCannon),
		...
		OBJECT(MODEL_LEGO_PIECE, -6989, 4689, 3476, 0, 0, 0, 0x00020000, bhvLegoPiece),
		...
		OBJECT(MODEL_LEGO_PIECE, -10139, 8016, 5000, 0, 90, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, -10139, 8875, 4450, 90, 90, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, -10139, 8566, 5550, 90, 0, 90, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, -9989, 9116, 5500, 0, -180, 0, 0x00020000, bhvLegoPiece),
