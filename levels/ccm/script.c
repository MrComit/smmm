...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_STAR_CURRENCY, 4477, 329, 8729, 0, 0, 0, 0x01000000, bhvStar),
		...
		OBJECT(MODEL_LEGO_PIECE, 7727, -71, 8729, 0, 90, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 7227, -71, 8729, 0, 90, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 6727, -71, 8729, 0, 90, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 6077, -71, 8729, 0, -180, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 5277, -71, 8729, 0, -180, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 4727, 329, 8729, -90, -90, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 4127, 329, 8729, -90, -90, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_LEGO_PIECE, 4477, -71, 8729, 0, -90, 0, 0x00020000, bhvLegoPiece),
		OBJECT(MODEL_MIPS, 12162, -41, 11182, 0, 0, 0, 0x01000000, bhvGardenMips),
		...
		OBJECT(MODEL_POUND_LEGO, 12002, -41, 11124, 0, 0, 0, 0x01000000, bhvPoundLego),
		OBJECT(MODEL_POUND_LEGO, 13967, -281, 9878, 0, 0, 0, 0x01000000, bhvPoundLego),
		OBJECT(MODEL_POUND_LEGO, 14266, -281, 6697, 0, 0, 0, 0x01000000, bhvPoundLego),
		OBJECT(MODEL_POUND_LEGO, 15528, -401, 6830, 0, 0, 0, 0x01000000, bhvPoundLego),
		OBJECT(MODEL_POUND_LEGO, 15479, -281, 8530, 0, 0, 0, 0x01000000, bhvPoundLego),
