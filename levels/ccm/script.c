...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_MIPS, 16355, -161, 10262, 0, 0, 0, 0x01000000, bhvGardenMips),
		...
		OBJECT(MODEL_POUND_LEGO, 15933, -161, 10488, 0, 0, 0, 0x01000000, bhvPoundLego),
		OBJECT(MODEL_POUND_LEGO, 14183, -161, 9988, 0, 0, 0, 0x01000000, bhvPoundLego),
		OBJECT(MODEL_POUND_LEGO, 14683, -161, 6738, 0, 0, 0, 0x01000000, bhvPoundLego),
		OBJECT(MODEL_POUND_LEGO, 13175, -161, 6383, 0, 0, 0, 0x01000000, bhvPoundLego),
		OBJECT(MODEL_POUND_LEGO, 15896, -161, 8570, 0, 0, 0, 0x01000000, bhvPoundLego),
