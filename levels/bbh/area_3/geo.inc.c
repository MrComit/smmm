...
const GeoLayout bbh_dl_305__SnowGlobe_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 3031, 2305, -6076, 0, -12, 0, bbh_dl_Castle_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 6586, 2349, -3428, 0, -12, 0, bbh_dl_CastleRuins_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5089, 1615, -2106, 0, -12, 0, bbh_dl_CastleRuins_001_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -2025, 2037, -7585, -11, 132, 16, bbh_dl_CastleRuins_002_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -2284, 320, -5459, bbh_dl_IcePlatforms_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -4696, 1503, -4946, 0, 31, 0, bbh_dl_IceSlide_mesh_layer_1),
		GEO_OPEN_NODE(),
...
const GeoLayout bbh_dl_306__UnderGlobe_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -8065, -2281, -5398, 0, 31, 0, bbh_dl_IceSlide_001_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, 1648, -2585, -7804, 0, -72, 0, bbh_dl_Waterfall_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
