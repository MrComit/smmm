...
const LevelScript level_bbh_entry[] = {
	...
	AREA(2, bbh_area_2),
		...
		OBJECT(MODEL_MONTY_MOLE, -3416, 39, 0, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -4087, 39, 0, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_BOO, -4531, 39, 0, 0, 0, 0, 0x050B0B00, bhvRoomBoo),
		...
		OBJECT(MODEL_STALACTITE, -9615, 5171, 0, 0, -36, 0, 0x00000000, bhvStalactite),
		OBJECT(MODEL_UNSTABLE_ROCK_YELLOW, -3632, 9000, 0, 0, -36, 0, 0x00000000, bhvUnstableRock),
		OBJECT(MODEL_UNSTABLE_ROCK_YELLOW, -2912, 9000, 0, 0, -36, 0, 0x00000000, bhvUnstableRock),
		OBJECT(MODEL_UNSTABLE_ROCK_YELLOW, -2289, 9000, 0, 0, -36, 0, 0x00000000, bhvUnstableRock),
