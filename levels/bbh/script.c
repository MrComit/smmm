...
const LevelScript level_bbh_entry[] = {
	...
	AREA(3, bbh_area_3),
		...
		OBJECT(MODEL_GLOBAL_GATE, 1709, 11749, -19188, 0, -25, 0, 0x00000000, bhvGlobalGate),
		...
		OBJECT(MODEL_ICE_CUBE_CRACKED, -565, 13600, -12285, 0, 0, 0, 0x00000000, bhvIceCubeCracked),
