...
const LevelScript level_bbh_entry[] = {
	...
	AREA(3, bbh_area_3),
		...
		OBJECT(MODEL_BOO_COIN, -5958, -328, 3446, 0, 0, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_HAUNTED_CAGE, -4648, -500, 3763, 0, 0, 0, 0x00010F00, bhvBooCoinCage),
		OBJECT(MODEL_BOO_COIN, -5556, -328, 4019, 0, 0, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_BOO_COIN, -6057, -328, 4626, 0, 0, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_BOO_COIN, -6869, -328, 3606, 0, 0, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_BOO_COIN, -6698, -328, 4297, 0, 0, 0, 0x00000000, bhvBooCoin),
