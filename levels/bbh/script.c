...
const LevelScript level_bbh_entry[] = {
	...
	AREA(3, bbh_area_3),
		...
		OBJECT(MODEL_STAR_CURRENCY, -495, -2937, -983, 0, 0, 0, 0x0E000000, bhvStar),
		...
		OBJECT(MODEL_TELEPORTER, -476, -3237, -917, 0, 0, 0, 0x00930000, bhvFadingWarp),
		...
		OBJECT(MODEL_SNOWFLAKE, 4430, 462, 7376, 0, -27, 0, 0x00000000, bhvSnowflake),
