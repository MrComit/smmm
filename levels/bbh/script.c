...
const LevelScript level_bbh_entry[] = {
	...
	AREA(2, bbh_area_2),
		...
		OBJECT(MODEL_STAR_CURRENCY, -8737, 6300, 0, 0, 0, 0, 0x0C000000, bhvStar),
		OBJECT(MODEL_MONTY_MOLE, -8297, 4471, 0, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -9289, 4471, 0, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_BOO, -10178, 4471, 0, 0, 0, 0, 0x050B0B00, bhvRoomBoo),
		OBJECT(MODEL_STALACTITE, -10439, 3671, 0, 0, -36, 0, 0x00000000, bhvStalactite),
		OBJECT(MODEL_STALACTITE, -5180, 3671, 0, 0, -36, 0, 0x00000000, bhvStalactite),
		OBJECT(MODEL_STALACTITE, -6004, 3671, 0, 0, -36, 0, 0x00000000, bhvStalactite),
		OBJECT(MODEL_UNSTABLE_ROCK_YELLOW, -9670, 2471, 0, 0, -36, 0, 0x00000000, bhvUnstableRock),
		OBJECT(MODEL_UNSTABLE_ROCK_YELLOW, -8950, 2471, 0, 0, -36, 0, 0x00000000, bhvUnstableRock),
		OBJECT(MODEL_UNSTABLE_ROCK_YELLOW, -8327, 2471, 0, 0, -36, 0, 0x00000000, bhvUnstableRock),
