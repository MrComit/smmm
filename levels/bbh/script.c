...
const LevelScript level_bbh_entry[] = {
	...
	AREA(2, bbh_area_2),
		...
		OBJECT(MODEL_NONE, -20684, 10200, 0, 0, 90, 0, 0x000B0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -20684, 10200, 0, 0, 90, 0, 0x000A0000, bhvFlyingWarp),
		OBJECT(MODEL_STAR_CURRENCY, -19279, 10300, 0, 0, 0, 0, 0x0B000000, bhvStar),
		OBJECT(MODEL_STAR_CURRENCY, -18737, 10300, 0, 0, 0, 0, 0x0C000000, bhvStar),
