...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_STAR_CURRENCY, -4768, 2539, -3297, 0, 0, 0, 0x05000000, bhvStar),
		OBJECT(MODEL_STAR_CURRENCY, -934, 4057, -7156, 0, 0, 0, 0x06000000, bhvStar),
		OBJECT(MODEL_STAR_CURRENCY, 2310, -275, -1450, 0, 0, 0, 0x08000000, bhvStar),
		...
		OBJECT(MODEL_NONE, -2022, 300, 859, 0, 0, 0, 0x09000000, bhvHiddenGreenCoinStar),
	...
	AREA(2, bbh_area_2),
		...
		OBJECT(MODEL_BOO, -5584, 409, 0, 0, 0, 0, (0x5 << 24) | (0xB << 16) | (0xA << 8), bhvRoomBoo),
	...
	AREA(3, bbh_area_3),
		...
		OBJECT(MODEL_HAUNTED_CAGE, -3054, -500, 2385, 0, 0, 0, (1 << 16) | (0xE << 8), bhvBooCoinCage),
		...
		OBJECT(MODEL_STAR_CURRENCY, -518, 1178, 15884, 0, 0, 0, 0x0C000000, bhvStar),
		...
		OBJECT(MODEL_STAR_CURRENCY, -233, -3070, 1861, 0, 0, 0, 0x0D000000, bhvStar),
