...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, -2022, 300, 859, 0, 0, 0, 0x05000000, bhvHiddenGreenCoinStar),
	...
	AREA(3, bbh_area_3),
		...
		WARP_NODE(0x3A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 2408, -300, 1559, 0, -90, 0, 0x000B0000, bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, 2408, -300, 1559, 0, -90, 0, 0x000A0000, bhvFlyingWarp),
		OBJECT(MODEL_NONE, 3615, 15204, -11147, 0, 90, 0, 0x003A0000, bhvFlyingWarp),
		...
		OBJECT(MODEL_GLOBAL_GATE, 1372, 11749, -17820, 0, 0, 0, (1 << 8), bhvGlobalGate),
