...
const LevelScript level_bbh_entry[] = {
	...
	AREA(3, bbh_area_3),
		...
		OBJECT(MODEL_GREEN_COIN, -3787, -500, 4247, 0, 0, 0, 0x00000000, bhvGreenCoin),
		OBJECT(MODEL_GREEN_COIN, -3653, -500, 3855, 0, 0, 0, 0x00000000, bhvGreenCoin),
		OBJECT(MODEL_GREEN_COIN, -4009, -500, 3892, 0, 0, 0, 0x00000000, bhvGreenCoin),
		OBJECT(MODEL_BOO_COIN, -6981, -635, 516, 0, 0, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_HAUNTED_CAGE, -4648, -500, 3763, 0, 0, 0, 0x00010F00, bhvBooCoinCage),
		OBJECT(MODEL_BOO_COIN, -5057, -652, 1692, 0, -36, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_BOO_COIN, -5610, -652, 2551, 0, 0, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_BOO_COIN, -6018, -652, 1095, 0, -36, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_BOO_COIN, -5813, -525, 390, 0, 0, 0, 0x00000000, bhvBooCoin),
		OBJECT(MODEL_STAR_CURRENCY, -133113, -200, -632, 0, 0, 0, 0x0D000000, bhvStar),
		OBJECT(MODEL_STAR_CURRENCY, -132810, -200, -50, 0, 0, 0, 0x0E000000, bhvStar),
		OBJECT(MODEL_STAR_CURRENCY, -132917, -200, 677, 0, 0, 0, 0x10000000, bhvStar),
		OBJECT(MODEL_NONE, -1146, -200, 2160, 0, 0, 0, 0x11000000, bhvHiddenGreenCoinStar),
		OBJECT(MODEL_UNSTABLE_ROCK, -6018, -892, 1095, 0, -36, 0, 0x00000000, bhvUnstableRock),
		OBJECT(MODEL_UNSTABLE_ROCK, -5057, -892, 1692, 0, -36, 0, 0x00000000, bhvUnstableRock),
		OBJECT(MODEL_UNSTABLE_ROCK, -5610, -892, 2551, 0, 0, 0, 0x00000000, bhvUnstableRock),
