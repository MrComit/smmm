...
const LevelScript level_bbh_entry[] = {
	...
	AREA(3, bbh_area_3),
		...
		OBJECT(MODEL_BOMB_CHAIN, 865, 15450, -13840, 0, 90, 0, (0xE << 16), bhvBombChain),
		...
		OBJECT(MODEL_ICE_CUBE, 5178, 11470, -11585, 0, 0, 0, (3 << 16), bhvIceCube),
		OBJECT(MODEL_ICE_CUBE, 2487, 11470, -9956, 0, 0, 0, (1 << 16), bhvIceCube),
		OBJECT(MODEL_ICE_CUBE, 5177, 11470, -9036, 0, 0, 0, (2 << 16), bhvIceCube),
