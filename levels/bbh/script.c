...
const LevelScript level_bbh_entry[] = {
	...
	AREA(3, bbh_area_3),
		...
		OBJECT(MODEL_BOMB_CHAIN, 3271, 14852, -10540, 0, 90, 0, (2 << 16), bhvBombChain),
		OBJECT(MODEL_BOMB_CHAIN, 3871, 14852, -10540, 0, 90, 0, (4 << 16), bhvBombChain),
		OBJECT(MODEL_BOMB_CHAIN, 5071, 14852, -10540, 0, 90, 0, (6 << 16), bhvBombChain),
		OBJECT(MODEL_BOMB_CHAIN, 5671, 14852, -10540, 0, -90, 0, (8 << 16), bhvBombChain),
