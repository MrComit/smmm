void scroll_bbh_dl_Grass_002_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 12;
	int width = 32 * 0x20;
	int height = 32 * 0x20;
	...
	float offsetY = 0.0;
	Vtx *vertices = segmented_to_virtual(bbh_dl_Grass_002_mesh_layer_5_vtx_0);
...
void scroll_bbh_dl_Waterfall_mesh_layer_2_vtx_0() {
	int i = 0;
	int count = 8;
	int width = 32 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bbh_dl_Waterfall_mesh_layer_2_vtx_0);
...
void scroll_bbh() {
	scroll_bbh_dl_Grass_002_mesh_layer_5_vtx_0();
	...
	scroll_bbh_dl_Waterfall_mesh_layer_2_vtx_0();
}
