...
const GeoLayout bbh_dl_101__Oasis_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, -3406, 582, -3160, bbh_dl__test_mesh_layer_1),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, 309, 425, 1246, bbh_dl_PIllars_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, -1867, 390, -1991, bbh_dl_PIllars_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(1, 871, 857, 1885, bbh_dl_Rope_mesh_layer_1),
