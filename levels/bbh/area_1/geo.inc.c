...
const GeoLayout bbh_dl_102__Tunnel_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(5, -380, 1934, -5824, bbh_dl_Waterfall_001_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(1, bbh_dl_Waterfall_001_mesh_layer_1),
			GEO_DISPLAY_LIST(4, bbh_dl_Waterfall_001_mesh_layer_4),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
