...
#include "game/behaviors/t_chamber.inc.c"
...
#include "game/behaviors/mind_palace.inc.c"
#include "game/behaviors/l8_2d_puzzle.inc.c"
#include "game/behaviors/dream_room.inc.c"
