...
s8 sLevelRoomOffsets[] = {0, 14, 32, 36, 41, 48, 64, 74, 86, 87, 0,};
...
void bhv_mario_update(void) {
    ...
    if (!(save_file_get_newflags(0) & SAVE_NEW_FLAG_MAINHALL_SCENE) && gMarioCurrentRoom == 2
        && gCurrLevelNum == LEVEL_BOB && gCurrDemoInput == NULL) {
    ...
    //     print_text_fmt_int(50, 4*20, "SUPER MARIO AND", 0, 4);
        // print_text_fmt_int(50, 3*20, "%x", save_file_get_challenges(0x25 / 32) & (1 << (0x25 % 32)), 5);
