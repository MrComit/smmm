...
void reverse_scroll_lll_dl_Treadmill_001_mesh_layer_1_vtx_1() {
	int i = 0;
	int count = 48;
	int width = 32 * 0x20;
	int height = 64 * 0x20;
...
void reverse_scroll_lll_dl_Treadmill_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 98;
	int width = 32 * 0x20;
	int height = 64 * 0x20;
...
void reverse_treadmill_scroll(void) {
	...
	reverse_scroll_lll_dl_Treadmill_002_mesh_layer_1_vtx_1();
	reverse_scroll_sts_mat_lll_dl_Treadmill_layer1();
	reverse_scroll_lll_dl_Treadmill_001_mesh_layer_1_vtx_1();
	reverse_scroll_lll_dl_Treadmill_mesh_layer_1_vtx_0();
	reverse_scroll_lll_dl_Treadmill_mesh_layer_1_vtx_2();
	reverse_scroll_sts_mat_lll_dl_TreadmillFAST_layer1();
}
