...
#define WARP_OP_WARP_FLOOR_OBJECT    0x1A
...
enum HUDDisplayFlag {
    ...
    HUD_DISPLAY_FLAG_STAR_PIECE = 0x0200,
    HUD_DISPLAY_FLAG_MULTIPLIER = 0x0400,
    HUD_DISPLAY_FLAG_BROKENKEY = 0x0800,
    HUD_DISPLAY_FLAG_TRACKER = 0x1000,
    HUD_DISPLAY_FLAG_CALL = 0x2000,
    HUD_DISPLAY_FLAG_BOO_COUNT = 0x4000,
    HUD_DISPLAY_FLAG_EMPHASIZE_POWER = 0x8000,

    HUD_DISPLAY_NONE = 0x0000,
    HUD_DISPLAY_DEFAULT = HUD_DISPLAY_FLAG_LOWER | HUD_DISPLAY_FLAG_LIVES | HUD_DISPLAY_FLAG_COIN_COUNT | HUD_DISPLAY_FLAG_STAR_COUNT | HUD_DISPLAY_FLAG_CAMERA_AND_POWER | HUD_DISPLAY_FLAG_KEYS | HUD_DISPLAY_FLAG_UNKNOWN_0020
};
