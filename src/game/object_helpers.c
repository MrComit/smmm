...
s8 sBooColorsDark[][3] = {
    {0x78 / 2, 0x64 / 2, 0xFF / 2},
    {0xCB / 2, 0xFF / 2, 0x74 / 2},
    {0xA5 / 2, 0xA5 / 2, 0xFF / 2},
    {0xd5 / 2, 0x4b / 2, 0x1c / 2},
    {0xFF / 2, 0x00 / 2, 0x00 / 2},
    {0x22 / 2, 0xa8 / 2, 0x2f / 2},
    {0xff / 2, 0xdc / 2, 0x47 / 2},
    {0xff / 2, 0xff / 2, 0xff / 2},
    {0x96 / 2, 0x69 / 2, 0x00 / 2},
    {0x9D / 2, 0x65 / 2, 0xE1 / 2},
    {0x55 / 2, 0x00 / 2, 0x9B / 2},
    {0x7D / 2, 0x5B / 2, 0x00 / 2},
    {0x64 / 2, 0xA5 / 2, 0xFF / 2},
    {0xff / 2, 0xff / 2, 0xff / 2},
    {0xff / 2, 0xff / 2, 0xff / 2},
    {0xff / 2, 0xff / 2, 0xff / 2},
    {0xff / 2, 0xff / 2, 0xff / 2},
